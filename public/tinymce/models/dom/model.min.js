...
!(function () {
  ...
  const No = () => Eo(),
    ...
    es = (e, t = !1) =>
      st(e) ? e.dom.isContentEditable : Zr(e).fold(g(t), e => "true" === ts(e)),
              ...
              const n =
                "text" === t.format
                  ? ((e, t) => {
                      ...
                      const s = (e => (ot(e) ? e : xe.fromDom(Ee(e).dom.body)))(
                        n
                      );
                      $e(r, t), Ie(s, r);
      ...
      unmerge: t => {
        ...
        return (
          ...
          () => {
            ...
            return (
              Lt(n, "width"), Lt(t, "width"), o.each(e => ge(n, "scope", e)), n
            );
          }
        );
      },
  ...
  const pi = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
    ...
    rm = (e, t, o, n, r) =>
      wt(n, "td,th", t).bind(n =>
        wt(n, "table", t).bind(s =>
          ((e, t) => ft(e, e => Ne(e).exists(e => Re(e, t)), void 0).isSome())(
            r,
            s
          )
            ? ((e, t, o) =>
      ...
      wt(e, "tr", t).bind(e =>
        wt(e, "table", t).bind(o => {
          ...
          return Re(e, n[n.length - 1])
            ? ((e, t, o) => Ni(_i, e, e => xr(e).isSome(), o))(o, 0, t).map(e =>
                si(C.some(vi(e, 0, e, 0)), !0)
              )
            : C.none();
        })
      ),
