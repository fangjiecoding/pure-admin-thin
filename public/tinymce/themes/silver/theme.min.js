...
!(function () {
  ...
  const dn = (e, t, o) => (e.stype === cn.Error ? t(e.serror) : o(e.svalue)),
    ...
    cs = e => as(e, $n),
    ds = (e, t) => os(e, e, { tag: "required", process: {} }, Fn(t)),
            ...
            const n = ((e, t) => {
                ...
                return {
                  ...
                  write: () => {
                    ...
                    F(["mousemove", "mouseover", "mouseout", vr()], e) ||
                      console.log(e, {
                        event: e,
                        time: s - n,
                        target: t.dom,
  ...
  var lc = Object.freeze({
    ...
    cc = [
      as("channels", Xn(ln.value, In([xi("onReceive"), ws("schema", Ln())])))
    ];
                  ...
                  const a = t => {
                      ...
                      const n =
                        null !== (o = t.raw.pseudoElement) && void 0 !== o
                          ...
                          : "";
                      return (
                        Ze(t.target, e) && De(n) && F(Fc, t.raw.propertyName)
                      );
                    },
                    i = r => {
                      if (m(r) || a(r)) {
  ...
  const Xc = "data-alloy-vertical-dir",
    Kc = e =>
      wl(e, e => je(e) && kt(e, "data-alloy-vertical-dir") === Yc.BottomToTop),
    Jc = () =>
      ys("layouts", [
        rs("onLtr"),
        rs("onRtl"),
  ...
  const ug = ua({ fields: dg, name: "disabling", active: cg, apis: lg }),
    ...
    gg = (e, t, o, n) => {
      mg(e, t, 0, [n]),
        pg(e, t, o, n) ||
          (ya(n.element, t.highlightClass), t.onHighlight(e, n), Fr(n, Br()));
    },
  ...
  var xg = Object.freeze({
      ...
      dehighlight: (e, t, o, n) => {
        pg(e, t, o, n) &&
          (Sa(n.element, t.highlightClass), t.onDehighlight(e, n), Fr(n, Ir()));
      },
      highlight: gg,
  ...
  const op = e => (t, o, n, s) => {
    ...
    up = (e, t, o) => {
      const n = kd(e, o);
      return (e => j(e, e => Ze(e, t)).map(t => ({ index: t, candidates: e })))(
        P(n, dp)
      );
    },
    mp = (e, t) => j(e, e => Ze(t, e)),
  ...
  const Tp = (e, t, o, n, s) => {
    ...
    Dp = (e, t, o) =>
      ((e, t) => t.focusManager.get(e).bind(e => _l(e, t.selector)))(e, o).bind(
        n => o.execute(e, t, n)
      ),
    Bp = (e, t, o) => {
      t.getInitial(e)
  ...
  const _f = e => t => t.options.get(e),
    ...
    Tb = e => (e.options.get("toolbar_sticky") || e.inline) && !kb(e) && !_b(e),
  ...
  const Db = ["visible", "hidden", "clip"],
    ...
    Fb = e => e.plugins.fullscreen && e.plugins.fullscreen.isFullscreen(),
    Rb = (e, t) =>
      Eb(e)
        ? ((e, t) => {
            const o = Cd(t, Ib),
  ...
  var Xb = Object.freeze({
      __proto__: null,
      hideAllExclusive: Yb,
      immediateOpenClose: (e, t, o, n) => Fr(e, n ? qb : Gb),
  ...
  const dv = Ov(Array.prototype.forEach),
    uv = Ov(Array.prototype.lastIndexOf),
    mv = Ov(Array.prototype.pop),
    gv = Ov(Array.prototype.push),
    pv = Ov(Array.prototype.splice),
    hv = Ov(String.prototype.toLowerCase),
    fv = Ov(String.prototype.toString),
    bv = Ov(String.prototype.match),
    vv = Ov(String.prototype.replace),
    xv = Ov(String.prototype.indexOf),
    yv = Ov(String.prototype.trim),
    wv = Ov(Object.prototype.hasOwnProperty),
    Sv = Ov(RegExp.prototype.test),
    Cv =
      ((kv = TypeError),
      function () {
  ...
  function _v(e, t) {
    let o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : hv;
    tv &&
   ...
   */ function Tv(e) {
    for (let t = 0; t < e.length; t++) wv(e, t) || (e[t] = null);
    return e;
  }
  /**
   ...
   */ function Av(e, t) {
    for (; null !== e; ) {
      const o = sv(e, t);
      if (o) {
        if (o.get) return Ov(o.get);
        if ("function" == typeof o.value) return Ov(o.value);
      }
      e = nv(e);
    }
    return function () {
  ...
  var Zv = (function e() {
    ...
    let { IS_ALLOWED_URI: z } = Jv,
      V = null;
    /**
     * We consider the elements and attributes below to be safe. Ideally
     * don't add any new ones but feel free to remove unwanted ones.
     */
    /* allowed element names */ const L = _v({}, [
      ...Mv,
      ...Dv,
      ...Bv,
      ...Fv,
    ...
    const ue = _v({}, ["audio", "video", "img", "source", "image", "track"]);
    ...
    let be = fe,
      ve = !1,
      xe = null;
    const ye = _v({}, [pe, he, fe], fv);
    let we = _v({}, ["mi", "mo", "mn", "ms", "mtext"]),
      Se = _v({}, ["annotation-xml"]);
    ...
    const Ee = n.createElement("form"),
      ...
      Me = function () {
        ...
        if (!Te || Te !== e) {
          if (
            ...
            (V = wv(e, "ALLOWED_TAGS") ? _v({}, e.ALLOWED_TAGS, _e) : L),
            (H = wv(e, "ALLOWED_ATTR") ? _v({}, e.ALLOWED_ATTR, _e) : P),
            (xe = wv(e, "ALLOWED_NAMESPACES")
              ? _v({}, e.ALLOWED_NAMESPACES, fv)
              : ye),
            (me = wv(e, "ADD_URI_SAFE_ATTR")
              ? _v(Ev(ge), e.ADD_URI_SAFE_ATTR, _e)
              : ge),
            (de = wv(e, "ADD_DATA_URI_TAGS")
              ? _v(Ev(ue), e.ADD_DATA_URI_TAGS, _e)
              : ue),
            (le = wv(e, "FORBID_CONTENTS")
              ? _v({}, e.FORBID_CONTENTS, _e)
              : ce),
            (W = wv(e, "FORBID_TAGS") ? _v({}, e.FORBID_TAGS, _e) : {}),
            ($ = wv(e, "FORBID_ATTR") ? _v({}, e.FORBID_ATTR, _e) : {}),
            (ie = !!wv(e, "USE_PROFILES") && e.USE_PROFILES),
            ...
            /* Parse profile info */ ie &&
              ((V = _v({}, Nv)),
              (H = []),
              !0 === ie.html && (_v(V, Mv), _v(H, zv)),
              !0 === ie.svg && (_v(V, Dv), _v(H, Vv), _v(H, Hv)),
              !0 === ie.svgFilters && (_v(V, Bv), _v(H, Vv), _v(H, Hv)),
              !0 === ie.mathMl && (_v(V, Fv), _v(H, Lv), _v(H, Hv))),
            /* Merge configuration parameters */ e.ADD_TAGS &&
              (V === L && (V = Ev(V)), _v(V, e.ADD_TAGS, _e)),
            e.ADD_ATTR && (H === P && (H = Ev(H)), _v(H, e.ADD_ATTR, _e)),
            e.ADD_URI_SAFE_ATTR && _v(me, e.ADD_URI_SAFE_ATTR, _e),
            e.FORBID_CONTENTS &&
              (le === ce && (le = Ev(le)), _v(le, e.FORBID_CONTENTS, _e)),
      ...
      Fe = function (e, t) {
        try {
          gv(o.removed, { attribute: t.getAttributeNode(e), from: t });
        } catch (e) {
          gv(o.removed, { attribute: null, from: t });
        }
     ...
     */ const He = function (e) {
        ...
        /* Now let's check the element's type and name */ const n = _e(
          e.nodeName
        );
        /* Execute a hook if present */
        /* Detect mXSS attempts abusing namespace confusion */
        if (
          (Le(E.uponSanitizeElement, e, { tagName: n, allowedTags: V }),
          e.hasChildNodes() &&
            !Ve(e.firstElementChild) &&
            Sv(/<[/\w]/g, e.innerHTML) &&
            Sv(/<[/\w]/g, e.textContent))
        )
          return Ie(e), !0;
        ...
        /* Remove element if anything forbids its presence */ if (
          ...
          if (!W[n] && Ue(n)) {
            if (U.tagNameCheck instanceof RegExp && Sv(U.tagNameCheck, n))
              return !1;
        ...
        /* Check whether element has a valid namespace */ return e instanceof
          ...
          : /* Make sure that older browsers don't get fallback-tag mXSS */
            ("noscript" !== n && "noembed" !== n && "noframes" !== n) ||
              !Sv(/<\/no(script|embed|frames)/i, e.innerHTML)
            ? /* Sanitize element content to be template-safe */
              (X &&
                ...
                e.textContent !== t &&
                  (gv(o.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
              /* Execute a hook if present */ Le(
                E.afterSanitizeElements,
                e,
                null
              ),
              !1)
        ...
        /* Allow valid data-* attributes: At least one character after "-"
          ...
          if (
            ...
            !(
              ...
              ("is" === t &&
                U.allowCustomizedBuiltInElements &&
                ((U.tagNameCheck instanceof RegExp && Sv(U.tagNameCheck, o)) ||
      ...
      Ue = function (e) {
        return "annotation-xml" !== e && bv(e, N);
      },
      We = function (e) {
        /* Execute a hook if present */
        Le(E.beforeSanitizeAttributes, e, null);
        ...
        /* Go backwards over all attributes; safely remove bad ones */ for (
          ...
          if (
            ...
            Le(E.uponSanitizeAttribute, e, n),
            (d = n.attrValue),
              ...
              try {
                i
                  ...
                  : /* Fallback to setAttribute() for browser-unrecognized namespaces e.g. "x-schema". */
                    e.setAttribute(a, d),
                  ze(e) ? Ie(e) : mv(o.removed);
              } catch (e) {}
          } else Fe(a, e);
        }
        /* Execute a hook if present */ Le(E.afterSanitizeAttributes, e, null);
      },
      $e = function e(t) {
        let o = null;
        const n = Ne(t);
        /* Execute a hook if present */ for (
          Le(E.beforeSanitizeShadowDOM, t, null);
          (o = n.nextNode());
    ...
    return (
      (o.sanitize = function (e) {
        ...
        if (
          ...
          if ("function" != typeof e.toString)
            throw Cv("toString is not a function");
          if ("string" != typeof (e = e.toString()))
            throw Cv("dirty is not a string, aborting");
        }
        ...
        /* Serialize doctype if allowed */ return (
          J &&
            ...
            Sv(Xv, n.ownerDocument.doctype.name) &&
      ...
      (o.addHook = function (e, t) {
        "function" == typeof t && gv(E[e], t);
      }),
      (o.removeHook = function (e, t) {
        if (void 0 !== t) {
          const o = uv(E[e], t);
          return -1 === o ? void 0 : pv(E[e], o, 1)[0];
        }
        return mv(E[e]);
      }),
  ...
  const ex = e => Zv().sanitize(e);
  var tx = tinymce.util.Tools.resolve("tinymce.util.I18n");
  const ox = {
      indent: !0,
      outdent: !0,
    ...
    nx = "temporary-placeholder",
    sx = e => () => fe(e, nx).getOr("!not found!"),
    rx = (e, t) => {
    ...
    cx = (e, t, o, n) => {
      var s, r;
      const a = (e => !!tx.isRtl() && be(ox, e))(t) ? ["tox-icon--flip"] : [],
        i = fe(o, rx(t, o)).or(n).getOrThunk(sx(o));
      return {
        dom: {
          tag: e.tag,
    ...
    mx = Gm({
      ...
      factory: e => {
        const t = Di("notification-text"),
          o = Lb({
            dom: Vb(
              `<p id=${t}>${ex(e.backstageProvider.translate(e.text))}</p>`
            ),
            behaviours: ca([_h.config({})])
          }),
          n = e => ({
          ...
          i = G([e.icon.toArray(), [e.level], A.from(ux[e.level]).toArray()]),
          l = Lb(
            zb.sketch({
              dom: {
                tag: "button",
  ...
  var hx = px;
  const fx = "tox-menu-nav__js",
    bx = "tox-collection__item",
    vx = "tox-swatch",
    xx = { normal: fx, color: vx },
    yx = "tox-collection__item--enabled",
    wx = "tox-collection__item-icon",
    Sx = "tox-collection__item-label",
    Cx = "tox-collection__item-caret",
    kx = "tox-collection__item--active",
    Ox = "tox-collection__item-container",
    _x = "tox-collection__item-container--row",
    Tx = e => fe(xx, e).getOr(fx),
    Ex = e => ("color" === e ? "tox-swatches" : "tox-menu"),
    Ax = e => ({
    ...
    Lx = Di("refetch-trigger-event"),
    Hx = Di("redirect-menu-item-interaction"),
    Px = "tox-menu__searcher",
    Ux = e =>
      Ol(e.element, `.${Px}`).bind(t => e.getSystem().getByDom(t).toOptional()),
    Wx = Ux,
    $x = e => ({
    ...
    jx = e => {
      const t = (e, t) => (t.cut(), A.none()),
        o = (e, t) => {
          ...
          return Rr(e, Hx, o), A.some(!0);
        },
        n = "searcher-events";
      return {
        dom: { tag: "div", classes: [bx] },
        components: [
          Vx.sketch({
            inputClasses: [Px, "tox-textfield"],
            inputAttributes: {
    ...
    Kx = (e, t, o) =>
      cf.parts.items({
        preprocess: n => {
          const s = V(n, o);
          return "auto" !== e && e > 1
            ? Yx({ tag: "div", classes: ["tox-collection__group"] }, e)(s)
            : Xx(s, (e, o) => "separator" === t[o].type);
        }
      }),
    Jx = (e, t, o = !0) => ({
      dom: {
    ...
    Qx = e => R(e, e => "icon" in e && void 0 !== e.icon),
    Zx = e => (console.error(Zn(e)), console.log(e), A.none()),
    ey = (e, t, o, n, s) => {
      const r =
        ((a = o),
        {
          ...
          components: [
            cf.parts.items({
              preprocess: e => Xx(e, (e, t) => "separator" === a[t].type)
            })
          ]
        });
      var a;
    ...
    ty = (e, t, o, n, s) => {
          ...
          components: [
            {
              ...
              components: [
                cf.parts.items({
                  preprocess:
                    "auto" !== e
                      ? Yx({ tag: "div", classes: ["tox-swatches__row"] }, e)
                      : w
                })
              ]
            }
            ...
            : "search-with-field" === s.searchMode.searchMode
              ? ((e, t, o) => {
                  ...
                  return {
                    ...
                    components: [
                      jx({ i18n: tx.translate, placeholder: o.placeholder }),
                      {
                        dom: {
                          tag: "div",
                          classes: [
              ...
              : ((e, t) => {
                  ...
                  return {
                    dom: {
                      tag: "div",
                      classes: ["tox-menu", "tox-collection", Gx].concat(
                        1 === e
                          ? ["tox-collection--list"]
                          : ["tox-collection--grid"]
                      ),
      ...
      return { value: e, dom: Dx(t, n, s.menuType), components: Bx, items: o };
    },
    oy = is("type"),
    ny = is("name"),
    sy = is("label"),
    ...
    Dy = Fn([oy, hy]),
    By = Fn([Ay("autocompleteitem"), Sy, ky, Ty, ly, hy, by]),
    Iy = [ky, vy, by, hy, gy, ks("context", "mode:design")],
    Fy = Fn([oy, uy, yy].concat(Iy)),
    Ry = e => Kn("toolbarbutton", Fy, e),
    Ny = [Sy].concat(Iy),
    zy = Fn(Ny.concat([oy, uy, yy])),
    Vy = e => Kn("ToggleButton", zy, e),
    Ly = [
      Ts("predicate", T),
    ...
    $y = [
      ...
      ps(
        "launch",
        es("type", { contextformbutton: Uy, contextformtogglebutton: Wy })
      ),
      Ts("onInput", b),
      Ts("onSetup", b)
    ],
    ...
    Yy = es("type", {
      contextform: jy,
      contextsliderform: Gy,
      contextsizeinputform: qy
    }),
    Xy = Fn(
      [
        Ay("contexttoolbar"),
    ...
    Jy = [oy, is("src"), fs("alt"), Es("classes", [], Un)],
    Qy = Fn(Jy),
    Zy = [oy, ry, py, Es("classes", ["tox-collection__item-label"], Un)],
    ew = Fn(Zy),
    tw = Dn(() =>
      qn("type", { cardimage: Qy, cardtext: ew, cardcontainer: ow })
    ),
    ow = Fn([
      oy,
  ...
  const sw = Fn([oy, xy, ms("items", tw), gy, Ey].concat(nw)),
    rw = Fn([oy, Sy, by].concat(nw)),
    aw = [oy, is("fancytype"), Ey],
    iw = [ws("initData", {})].concat(aw),
    lw = [
      vs("select"),
      As("initData", {}, [
    ...
    cw = es("fancytype", { inserttable: iw, colorswatch: lw }),
    dw = Fn([oy, gy, Ey, by].concat(nw)),
    uw = Fn([oy, dy, gy, by].concat(nw)),
    mw = Fn([oy, by, Sy, gy, uy].concat(nw)),
    gw = (e, t, o) => {
    ...
    pw = e => ((e, t) => ca([Th(e, t)]))(Di("unnamed-events"), e),
    hw = e =>
      ug.config({
        disabled: e,
        disableClass: "tox-collection__item--state-disabled"
      }),
    fw = e => ug.config({ disabled: e }),
    bw = e => ug.config({ disabled: e, disableClass: "tox-tbtn--disabled" }),
    vw = e =>
      ug.config({
        disabled: e,
      ...
      e.on("init SwitchMode", e => {
        ...
        e.on("DisabledStateChange", o => {
          if (!o.isDefaultPrevented()) {
            const n = o.state ? Cw : kw;
            _w(t, n), o.state || e.nodeChanged();
          }
        }),
        e.on("NodeChange", o => {
          const n = e.ui.isEnabled() ? o.type : Cw;
          _w(t, n);
        }),
    ...
    Ew = e =>
      dc.config({
        channels: {
          [Sw]: {
            onReceive: (t, o) => {
              if (o === Cw || "setEnabled" === o)
                return void ug.set(t, o === Cw);
              const { contextType: n, shouldDisable: s } = e();
              ("mode" !== n || F(Ow, o)) && ug.set(t, s);
            }
          }
        }
      }),
    ...
    Bw = (e, t, o, n) => {
      ...
      return {
        type: "item",
        dom: t.dom,
        components: Dw(t.optComponents),
        data: e.data,
        eventOrder: Mw,
        hasSubmenu: e.triggersSubmenu,
        itemBehaviours: ca(
          [
            Th("item-events", [Aw(e, o), yw(e, s), ww(e, s)]),
            hw(
              () =>
                !e.enabled || n.checkUiComponentContext(e.context).shouldDisable
            ),
            Ew(() => n.checkUiComponentContext(e.context)),
            _h.config({})
          ].concat(e.itemBehaviours)
        )
      };
    },
    Iw = e => ({ value: e.value, meta: { text: e.text.getOr(""), ...e.meta } }),
    Fw = e => {
    ...
    Rw = (e, t, o = [wx]) => dx(e, { tag: "div", classes: o }, t),
    Nw = e => ({
      dom: { tag: "div", classes: [Sx] },
      components: [dl(tx.translate(e))]
    }),
    zw = (e, t) => ({ dom: { tag: "div", classes: t, innerHtml: e } }),
    Vw = (e, t) => ({
      dom: { tag: "div", classes: [Sx] },
      components: [
        {
          dom: { tag: e.tag, styles: e.styles },
          components: [dl(tx.translate(t))]
        }
      ]
    }),
    Lw = e => ({
    ...
    Hw = e => Rw("checkmark", e, ["tox-collection__item-checkmark"]),
    Pw = e => {
      const t = e
        .map(e => ({
          attributes: { id: Di("menu-item"), "aria-label": tx.translate(e) }
        }))
        .getOr({});
      return { tag: "div", classes: [fx, bx], ...t };
    },
    Uw = (e, t, o, n = A.none()) =>
      "color" === e.presets
        ? ((e, t, o) => {
            const n = e.value,
              s = e.iconContent.map(e =>
                ((e, t, o) => {
                  const n = t();
                  return ax(e, n).or(o).getOrThunk(sx(n));
                })(e, t.icons, o)
              ),
              r = e.ariaLabel
                .map(e => ({
        ...
        : ((e, t, o, n) => {
            const s = { tag: "div", classes: [wx] },
              r = o
                ? e.iconContent
                    .map(e => dx(e, s, t.icons, n))
                    .orThunk(() => A.some({ dom: s }))
                : A.none(),
              a = e.checkMark,
              i = A.from(e.meta).fold(
                () => Nw,
                e => (be(e, "style") ? C(Vw, e.style) : Nw)
              ),
            ...
            return {
              dom: Pw(e.ariaLabel),
              optComponents: [r, l, e.shortcutContent.map(Lw), a, e.caret]
            };
          })(e, t, o, n),
    Ww = (e, t, o) =>
      fe(e, "tooltipWorker")
    ...
    $w = (e, t) => {
      const o = (e => Cf.DOM.encode(e))(tx.translate(e));
      if (t.length > 0) {
        const e = new RegExp(
          (e => e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"))(t),
          "gi"
      ...
      V(e, e => {
        switch (e.type) {
          ...
          case "cardtext":
            ...
            return zw($w(e.text, n), e.classes);
        }
      }),
    Gw = Om(tf(), of()),
    qw = e => ({ value: Jw(e) }),
    Yw = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
    Xw = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i,
    Kw = e => Yw.test(e) || Xw.test(e),
    Jw = e => Oe(e, "#").toUpperCase(),
    Qw = e => {
      const t = e.toString(16);
      return (1 === t.length ? "0" + t : t).toUpperCase();
    },
    Zw = e => {
      const t = Qw(e.red) + Qw(e.green) + Qw(e.blue);
      return qw(t);
    },
    eS = Math.min,
    tS = Math.max,
    oS = Math.round,
    nS = /^\s*rgb\s*\(\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*(\d+)\s*\)\s*$/i,
    sS =
      /^\s*rgba\s*\(\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*((?:\d?\.\d+|\d+)%?)\s*\)\s*$/i,
    rS = (e, t, o, n) => ({ red: e, green: t, blue: o, alpha: n }),
    aS = e => {
    ...
    iS = e => {
      ...
      let r = e.saturation / 100,
        a = e.value / 100;
      if (((r = tS(0, eS(r, 1))), (a = tS(0, eS(a, 1))), 0 === r))
        return (t = o = n = oS(255 * a)), rS(t, o, n, 1);
      const i = s / 60,
        l = a * r,
    ...
    dS = e => {
      const t = nS.exec(e);
      if (null !== t) return A.some(cS(t[1], t[2], t[3], "1"));
      const o = sS.exec(e);
      return null !== o ? A.some(cS(o[1], o[2], o[3], o[4])) : A.none();
    },
    uS = e => `rgba(${e.red},${e.green},${e.blue},${e.alpha})`,
    mS = rS(255, 0, 0, 1),
    gS = (e, t) => {
  ...
  const kS = {},
    ...
    TS = (e, t, o) => ({ hue: e, saturation: t, value: o }),
    ES = e => {
      let t = 0,
        o = 0,
        n = 0;
      ...
      return i === l
        ...
        : ((t = s === i ? 3 : a === i ? 1 : 5),
          ...
          (o = (l - i) / l),
          (n = l),
          TS(Math.round(t), Math.round(100 * o), Math.round(100 * n)));
    },
    AS = e => Zw(iS(e)),
    MS = "forecolor",
    DS = "hilitecolor",
    ...
    IS = e => t => t.options.get(e),
    FS = "#000000",
    RS = (e, t) =>
      t === MS && e.options.isSet("color_map_foreground")
        ? IS("color_map_foreground")(e)
        : t === DS && e.options.isSet("color_map_background")
          ? IS("color_map_background")(e)
          : e.options.isSet("color_map_raw")
            ? IS("color_map_raw")(e)
            : IS("color_map")(e),
    NS = (e, t = "default") =>
      Math.max(5, Math.ceil(Math.sqrt(RS(e, t).length))),
    zS = (e, t) => {
      const o = IS("color_cols")(e),
        n = NS(e, t);
      return o === NS(e) ? n : o;
    },
    VS = (e, t = "default") =>
      Math.round(
        t === MS
          ? IS("color_cols_foreground")(e)
          : t === DS
            ? IS("color_cols_background")(e)
            : IS("color_cols")(e)
      ),
    LS = IS("custom_colors"),
    HS = IS("color_default_foreground"),
    PS = IS("color_default_background"),
    US = (e, t) => {
    ...
    $S = (e, t, o, n) => {
      "custom" === o
        ? ZS(e)(o => {
            o.each(o => {
              _S(t, o), e.execCommand("mceApplyTextcolor", t, o), n(o);
            });
          }, US(e, t).getOr(FS))
        : "remove" === o
    ...
    JS = (e, t, o, n) => {
      e.ui.registry.addSplitButton(t, {
        tooltip: KS(e, o, n.get()),
        presets: "color",
        icon: "forecolor" === t ? "text-color" : "highlight-bg-color",
        select: XS(e, o),
        columns: VS(e, o),
        fetch: GS(RS(e, o), o, LS(e)),
        onAction: t => {
          $S(e, o, n.get(), b);
        },
        onItemAction: (s, r) => {
          $S(e, o, r, o => {
            n.set(o), pS(e, { name: t, color: o });
          });
        },
        onSetup: s => {
          qS(s, t, n.get());
          const r = n => {
            n.name === t && (qS(s, n.name, n.color), YS(s, KS(e, o, n.color)));
          };
          return (
    ...
    QS = (e, t, o, n, s) => {
      e.ui.registry.addNestedMenuItem(t, {
        text: n,
        icon: "forecolor" === t ? "text-color" : "highlight-bg-color",
        onSetup: n => (YS(n, KS(e, o, s.get())), qS(n, t, s.get()), vS(e)(n)),
        getSubmenuItems: () => [
          {
            type: "fancymenuitem",
    ...
    eC = (e, t, o, n, s, r, a, i) => {
      const l = Qx(t),
        c = tC(t, o, n, "color" !== s ? "normal" : "color", r, a, i);
      return ty(e, l, c, n, { menuType: s });
    },
    tC = (e, t, o, n, s, r, a) =>
      ye(
        V(e, i => {
          return "choiceitem" === i.type
            ? ((l = i), Kn("choicemenuitem", rw, l)).fold(Zx, i =>
                A.some(
                  ((e, t, o, n, s, r, a, i = !0) => {
                    const l = Uw(
                        {
                          ...
                          checkMark: t ? A.some(Hw(a.icons)) : A.none(),
                          caret: A.none(),
                          value: e.value
                        },
                        a,
    ...
    rC = (e, t, o) => {
      ...
      return pl({
        ...
        behaviours: ca([
          ...
          Bh.config({ onFocus: o => Rr(o, nC, { row: e, col: t }) })
        ])
      });
    },
    aC = e => q(e, e => V(e, hl)),
    ...
    lC = {
        ...
        return {
          ...
          components: [
            Gw.widget({
              ...
              components: aC(n).concat(r.asSpec()),
              behaviours: ca([
      ...
      colorswatch: (e, t) => {
        ...
        return {
          ...
          dom: { tag: "div", classes: ["tox-fancymenuitem"] },
          autofocus: !0,
          components: [Gw.widget(cf.sketch(r))]
        };
      }
    },
    cC = e => ({
      type: "separator",
      dom: { tag: "div", classes: [bx, "tox-collection__group-heading"] },
  ...
  const gC = ua({ fields: uC, name: "coupling", apis: dC, state: mC }),
    pC = e => {
      let t = A.none(),
        o = [];
      const n = e => {
    ...
    bC = e => {
      ...
      return {
        map: t => bC(() => e().then(t)),
        bind: t => bC(() => e().then(e => t(e).toPromise())),
        anonBind: t => bC(() => e().then(() => t.toPromise())),
        toLazy: () => hC.nu(t),
        toCached: () => {
          let t = null;
          return bC(() => (null === t && (t = e()), t));
        },
        toPromise: e,
        get: t
      };
    },
    vC = e => bC(() => new Promise(e)),
    xC = e => bC(() => Promise.resolve(e)),
    yC = y("sink"),
    wC = y(
      ym({
        name: yC(),
    ...
    kC = (e, t, o, n, s, r, a) => (ku.close(n), xC(n)),
    OC = (e, t, o, n, s, r) => {
      const a = gC.getCoupled(o, "sandbox");
      return (ku.isOpen(a) ? kC : CC)(e, t, o, a, n, s, r);
    },
    _C = (e, t) =>
      e
        .getSystem()
    ...
    EC = (e, t, o) => {
      ...
      return {
        ...
        behaviours: Xu(e.sandboxBehaviours, [
          ...
          Jm.config({ find: e => ku.getState(e).bind(e => Jm.getCurrent(e)) }),
          dc.config({
            channels: { ...Au({ isExtraPart: T }), ...Du({ doReposition: TC }) }
          })
        ])
      };
    },
    AC = e => {
      const t = gC.getCoupled(e, "sandbox");
      TC(t);
    },
    MC = () => [
      ws("sandboxClasses", []),
    ...
    DC = y(
      [
        ...
        Jc(),
        ju("dropdownBehaviours", [Hh, gC, bh, Bh]),
        rs("toggleClass"),
        ws("eventOrder", {}),
        gs("lazySink"),
        ws("matchWidth", !1),
      ...
      factory: (e, t, o, n) => {
        const s = e => {
          ...
          a = {
            ...
            refetch: t =>
              gC.getExistingCoupled(t, "sandbox").fold(
        ...
        return {
          ...
          behaviours: qu(e.dropdownBehaviours, [
            ...
            gC.config({
              others: {
                sandbox: t =>
                  EC(e, t, { onOpen: () => Hh.on(t), onClose: () => Hh.off(t) })
              }
            }),
            bh.config({
              mode: "special",
              ...
              onEscape: (e, t) =>
                IC.isOpen(e) ? (IC.close(e), A.some(!0)) : A.none()
            }),
            Bh.config({})
          ]),
          events: Wh(
  ...
  const VC = (e, t, o, n, s) => {
      ...
      switch (e.type) {
        case "menuitem":
          return ((i = e), Kn("menuitem", dw, i)).fold(Zx, e =>
            A.some(
              ((e, t, o, n = !0) => {
                const s = Uw(
                  {
        ...
        case "nestedmenuitem":
          return (e => Kn("nestedmenuitem", uw, e))(e).fold(Zx, e =>
            A.some(
              ((e, t, o, n = !0, s = !1) => {
                const r = s
                  ? ((a = o.icons), Rw("chevron-down", a, [Cx]))
                  : (e => Rw("chevron-right", e, [Cx]))(o.icons);
                var a;
                const i = Uw(
                  {
                    presets: "normal",
        ...
        case "togglemenuitem":
          return (e => Kn("togglemenuitem", mw, e))(e).fold(Zx, e =>
            A.some(
              ((e, t, o, n = !0) => {
                const s = Uw(
                  {
        ...
        case "separator":
          return (e => Kn("separatormenuitem", Dy, e))(e).fold(Zx, e =>
            A.some(cC(e))
          );
        case "fancymenuitem":
          return (e => Kn("fancymenuitem", cw, e))(e).fold(Zx, e =>
            ((e, t) => fe(lC, e.fancytype).map(o => o(e, t)))(e, o)
          );
        default:
    ...
    LC = (e, t, o, n, s, r, a) => {
      ...
      return ye(
        V(e, e => {
          switch (e.type) {
            case "separator":
              return ((n = e), Kn("Autocompleter.Separator", Dy, n)).fold(
                Zx,
                e => A.some(cC(e))
              );
            case "cardmenuitem":
              return (e => Kn("cardmenuitem", sw, e))(e).fold(Zx, e =>
                A.some(
                  ((e, t, o, n) => {
                    const s = {
                      dom: Pw(e.label),
                      optComponents: [
                        A.some({
                          dom: { tag: "div", classes: [Ox, _x] },
                          components: jw(e.items, n)
                        })
                      ]
                    };
                    return Bw(
                    ...
                    r,
                    {
                      itemBehaviours: Ww(e.meta, r, A.none()),
            ...
            default:
              return (e => Kn("Autocompleter.Item", By, e))(e).fold(Zx, e =>
                A.some(
                  ((e, t, o, n, s, r, a, i = !0) => {
                    const l = Uw(
                        {
                          presets: n,
                          textContent: A.none(),
                          htmlContent: o ? e.text.map(e => $w(e, t)) : A.none(),
                          ariaLabel: e.text,
                          iconContent: e.icon,
    ...
    HC = (e, t, o, n, s, r) => {
      const a = Qx(t),
        i = ye(
          V(t, e => {
            const t = e => VC(e, o, n, (e => (s ? !be(e, "text") : a))(e), s);
      ...
      return (s ? ey : ty)(e, a, i, 1, l);
    },
    PC = e => vf.singleData(e.value, e),
    UC = e =>
                ...
                xf.showMenuAt(
                  ...
                  ((e, t, o, n) => {
                    ...
                    return {
                      ...
                      menu: { markers: Mx(n), fakeFocus: o === zC.ContentFocus }
                    };
                  })(
                    ty("autocompleter-value", !0, o, n, { menuType: "normal" }),
                    n,
                    zC.ContentFocus,
                    "normal"
                  )
          ...
          o.triggerEvent("keydown", e)
            ...
            : o.stopBackspace &&
              (e =>
                ...
                !$C(e.target, '[contenteditable="true"]'))(e) &&
              e.prevent();
        }),
        l = Dc(e, "focusin", e => {
    ...
    XC = Ms([{ stopped: [] }, { resume: ["element"] }, { complete: [] }]),
    KC = (e, t, o, n, s, r) => {
      const a = e(t, n),
        i = ((e, t) => {
          const o = en(!1),
      ...
      return a.fold(
        () => (r.logEventNoHandlers(t, n), XC.complete()),
        e => {
          const o = e.descHandler;
          return (
            qi(o)(i),
            i.isStopped()
              ? (r.logEventStopped(t, e.element, o.purpose), XC.stopped())
              : i.isCut()
                ? (r.logEventCut(t, e.element, o.purpose), XC.complete())
                : rt(e.element).fold(
                    () => (
                      r.logNoParent(t, e.element, o.purpose), XC.complete()
                    ),
                    n => (
                      r.logEventResponse(t, e.element, o.purpose), XC.resume(n)
                    )
                  )
          );
        }
    ...
    JC = (e, t, o, n, s, r) =>
      KC(e, t, o, n, s, r).fold(E, n => JC(e, t, o, n, s, r), T),
    QC = (e, t, o, n, s) => {
      const r = YC(o, n);
      return JC(e, t, o, n, r, s);
    },
    ZC = () => {
      const e = (() => {
          const e = {};
    ...
    tk = e => {
      const t = t => rt(e.element).fold(E, e => Ze(t, e)),
        ...
        s = qC(e.element, {
          triggerEvent: (e, t) =>
            li(e, t.target, o =>
              ((e, t, o, n) => QC(e, t, o, o.target, n))(n, e, t, o)
            )
        }),
        r = {
          debugInfo: y("real"),
          triggerEvent: (e, t, o) => {
            li(e, t, s => QC(n, e, o, t, s));
          },
          triggerFocus: (e, t) => {
            zi(e).fold(
              () => {
    ...
    ok = y([ws("prefix", "form-field"), ju("fieldBehaviours", [Jm, $u])]),
    nk = y([
  ...
  var rk = tinymce.util.Tools.resolve("tinymce.html.Entities");
  const ak = (e, t, o, n) => {
      const s = ik(e, t, o, n);
      return sk.sketch(s);
    },
    ...
    lk = e => ({ tag: "div", classes: ["tox-form__group"].concat(e) }),
    ck = (e, t) =>
      sk.parts.label({
        dom: { tag: "label", classes: ["tox-label"] },
        components: [dl(t.translate(e))]
      }),
    dk = Di("form-component-change"),
    uk = Di("form-component-input"),
    mk = Di("form-close"),
    gk = Di("form-cancel"),
    pk = Di("form-action"),
    hk = Di("form-submit"),
    fk = Di("form-block"),
    bk = Di("form-unblock"),
    vk = Di("form-tabchange"),
    xk = Di("form-resize"),
    yk = (e, t, o) => {
      const n = e.label.map(e => ck(e, t)),
        s = t.icons(),
        r = e => (t, o) => {
        ...
        c = sk.parts.field({
          ...
          behaviours: ca([
            ...
            Ew(() => t.checkUiComponentContext(e.context)),
            _h.config({}),
            Zb.config({
              ...t.tooltips.getConfig({
                tooltipText: "",
                onShow: e => {
                  Ol(e.element, "." + kx + "[data-mce-tooltip]").each(o => {
                ...
                ((o, n) => {
                  const r =
                    ...
                    a = V(n, t => {
                      ...
                      return `<div data-mce-tooltip="${l}" class="tox-collection__item${r}" tabindex="-1" data-collection-item-value="${rk.encodeAllRaw(t.value)}" aria-label="${l}">${a}${n}</div>`;
                    }),
                    i =
                  ...
                  "auto" === e.columns &&
                    gw(o, 5, "tox-collection__item").each(
      ...
      var d;
      return ak(n, c, ["tox-form__group--collection"], []);
    },
    wk = ["input", "textarea"],
    Sk = e => {
      const t = Ue(e);
    ...
    Ck = (e, t) => {
      ...
      Sa(o, t.invalidClass),
        t.notify.each(t => {
          Sk(e.element) && St(e.element, "aria-invalid", !1),
    ...
    kk = (e, t, o, n) => {
      ...
      ya(s, t.invalidClass),
        t.notify.each(t => {
          Sk(e.element) && St(e.element, "aria-invalid", !0),
            t.getContainer(e).each(e => {
              oi(e, n);
            }),
            t.onInvalid(e, n);
  ...
  const Mk = ua({
    ...
    Bk = Di("color-input-change"),
    Ik = Di("color-swatch-change"),
    Fk = Di("color-picker-cancel"),
    Rk = ym({ schema: [rs("dom")], name: "label" }),
    Nk = e =>
      ym({
        name: e + "-edge",
        overrides: t =>
      ...
      overrides: e => {
        ...
        return {
          behaviours: ca([
            bh.config({
              mode: "special",
              onLeft: (o, n) => t.onLeft(o, e, Gk(n)),
              onRight: (o, n) => t.onRight(o, e, Gk(n)),
              onUp: (o, n) => t.onUp(o, e, Gk(n)),
              onDown: (o, n) => t.onDown(o, e, Gk(n))
            }),
            Ub.config({}),
            Bh.config({})
          ]),
  ...
  const Yk = y("slider.change.value"),
    Xk = e => {
      const t = e.event.raw;
    ...
    iO = e => rO(e) / 2,
    lO = e => aO(e) / 2,
    cO = (e, t) => (t ? e.stepSize * e.speedMultiplier : e.stepSize),
    dO = e => e.snapToGrid,
    uO = e => e.snapStart,
    mO = e => e.rounded,
    gO = (e, t) => void 0 !== e[t + "-edge"],
    pO = e => gO(e, "left"),
    hO = e => gO(e, "right"),
    fO = e => gO(e, "top"),
    bO = e => gO(e, "bottom"),
    vO = e => e.model.value.get(),
    xO = (e, t) => ({ x: e, y: t }),
    yO = (e, t) => {
      Rr(e, Yk(), { value: t });
    },
    ...
    EO = "bottom",
    AO = "left",
    MO = e => e.element.dom.getBoundingClientRect(),
    DO = (e, t) => e[t],
    BO = e => {
      const t = MO(e);
      return DO(t, AO);
    ...
    WO = e => (t, o, n) =>
      ((e, t, o, n) => {
        const s = (e > 0 ? SO : wO)(vO(o), Kk(o), eO(o), cO(o, n));
        return PO(t, s), A.some(s);
      })(e, t, o, n).map(E),
    $O = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n, s) => {
        const r = NO(e),
          a = n.bind(t => A.some(LO(t, e))).getOr(0),
          i = s.bind(t => A.some(LO(t, e))).getOr(r),
          l = {
            min: Kk(t),
            max: eO(t),
            range: rO(t),
  ...
  var KO = Object.freeze({
    ...
    getValueFromEvent: e => Xk(e).map(e => e.left),
    findPositionOfValue: $O,
    setPositionFromValue: (e, t, o, n) => {
      const s = vO(o),
        r = $O(e, n.getSpectrum(e), s, n.getLeftEdge(e), n.getRightEdge(e), o),
        a = Kt(t.element) / 2;
  ...
  const JO = (e, t) => {
    ...
    ZO = e => (t, o, n) =>
      ((e, t, o, n) => {
        const s = (e > 0 ? SO : wO)(vO(o), Jk(o), tO(o), cO(o, n));
        return JO(t, s), A.some(s);
      })(e, t, o, n).map(E),
    e_ = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n, s) => {
        const r = zO(e),
          a = n.bind(t => A.some(HO(t, e))).getOr(0),
          i = s.bind(t => A.some(HO(t, e))).getOr(r),
          l = {
            min: Jk(t),
            max: tO(t),
            range: aO(t),
  ...
  var a_ = Object.freeze({
    ...
    findValueOfOffset: QO,
    getValueFromEvent: e => Xk(e).map(e => e.top),
    findPositionOfValue: e_,
    setPositionFromValue: (e, t, o, n) => {
      const s = vO(o),
        r = e_(e, n.getSpectrum(e), s, n.getTopEdge(e), n.getBottomEdge(e), o),
        a = Ut(t.element) / 2;
  ...
  const i_ = (e, t) => {
    ...
    c_ = (e, t) => (o, n, s) =>
      ((e, t, o, n, s) => {
        const r = e > 0 ? SO : wO,
          a = t ? vO(n).x : r(vO(n).x, Kk(n), eO(n), cO(n, s)),
          i = t ? r(vO(n).y, Jk(n), tO(n), cO(n, s)) : vO(n).y;
        return i_(o, l_(a, i)), A.some(a);
      })(e, t, o, n, s).map(E),
    d_ = c_(-1, !1),
    u_ = c_(1, !1),
    m_ = c_(-1, !0),
  ...
  const f_ = qm({
    ...
    b_ = Di("rgb-hex-update"),
    v_ = Di("slider-update"),
    x_ = Di("palette-update"),
    y_ = "form",
    w_ = [ju("formBehaviours", [$u])],
    S_ = e => "<alloy.field." + e + ">",
    C_ = (e, t) => ({
      uid: e.uid,
      dom: e.dom,
    ...
    k_ = {
      ...
      sketch: e => {
        const t = (() => {
            const e = [];
            return {
              field: (t, o) => (e.push(t), Tm(y_, S_(t), o)),
              record: y(e)
            };
          })(),
          o = e(t),
          n = t.record(),
          s = V(n, e => vm({ name: e, pname: S_(e) }));
        return Um(y_, w_, s, C_, o);
      }
    },
    O_ = Di("valid-input"),
    __ = Di("invalid-input"),
    T_ = Di("validating-input"),
    E_ = "colorcustom.rgb.",
    A_ = {
      isEnabled: E,
      setEnabled: b,
    ...
    M_ = (e, t, o, n, s, r) => {
      const a = (e, t) => {
        ...
        i = (o, n, s) =>
          Mk.config({
            ...
            notify: {
              ...
              onValid: e => {
                a(!1, s), Rr(e, O_, { type: o, value: $u.getValue(e) });
              },
              onInvalid: e => {
                a(!0, s), Rr(e, __, { type: o, value: $u.getValue(e) });
              }
            },
            validator: {
              validate: t => {
        ...
        l = (o, n, a, l, c) => {
          const d = en(A_),
            u = e(E_ + "range"),
            m = sk.parts.label({ dom: { tag: "label" }, components: [dl(a)] }),
            g = sk.parts.field({
              data: c,
              factory: Vx,
              inputAttributes: {
            ...
            v = "hex" !== n ? [sk.parts["aria-descriptor"]({ text: u })] : [],
            x = f.concat(v);
          return {
            dom: {
              tag: "div",
        ...
        m = Gm({
          factory: () => {
            const s = {
              ...
              p = t => ({
                label: e(E_ + t + ".label"),
                description: e(E_ + t + ".description")
              }),
              h = p("red"),
              f = p("green"),
              b = p("blue"),
            ...
            return xn(
              k_.sketch(o => ({
                ...
                components: [
                  o.field(
                    "red",
                    sk.sketch(l(aS, "red", h.label, h.description, 255))
                  ),
                  o.field(
                    "green",
                    sk.sketch(l(aS, "green", f.label, f.description, 255))
                  ),
                  o.field(
                    "blue",
                    sk.sketch(l(aS, "blue", b.label, b.description, 255))
                  ),
                  o.field(
                    "hex",
                    sk.sketch(l(Kw, "hex", v.label, v.description, "ffffff"))
                  ),
                  d.asSpec()
                ],
                formBehaviours: ca([
                  Mk.config({ invalidClass: t("form-invalid") }),
                  Th("rgb-form-events", [Wr(O_, g), Wr(__, m), Wr(T_, m)])
                ])
              })),
              {
                apis: {
    ...
    D_ = (e, t, o, n) => {
      const s = Gm({
        ...
        factory: s => {
          const r = M_(e, t, s.onValidHex, s.onInvalidHex, o, n),
            a = ((e, t) => {
              const o = f_.parts.spectrum({
                  dom: {
                    tag: "canvas",
                    attributes: { role: "presentation" },
              ...
              return Gm({
                ...
                apis: {
                  ...
                  setThumb: (t, o, n) => {
                    ((t, o) => {
                      const n = ES(lS(o));
                      f_.setValue(t, { x: n.saturation, y: 100 - n.value }),
                        St(
                          t.element,
                          "aria-valuetext",
                          e([
            ...
            i = { paletteRgba: en(mS), paletteHue: en(0) },
            l = Lb(
              ((e, t) => {
                const o = f_.parts.spectrum({
                    dom: {
            ...
            g = (e, t, o) => {
              l.getOpt(e).each(e => {
                f_.setValue(e, (e => 100 - (e / 360) * 100)(o));
              });
            },
            p = (e, t) => {
              c.getOpt(e).each(e => {
    ...
    B_ = () => Jm.config({ find: A.some }),
    I_ = e =>
      Jm.config({
        find: t =>
          ct(t.element, e).bind(e => t.getSystem().getByDom(e).toOptional())
      }),
    F_ = Fn([ws("preprocess", w), ws("postprocess", w)]),
    R_ = (e, t) => {
      const o = Qn("RepresentingConfigs.memento processors", F_, t);
      return $u.config({
        store: {
          mode: "manual",
          getValue: t => {
    ...
    V_ = e => $u.config({ store: { mode: "memory", initialValue: e } }),
    L_ = {
  ...
  var H_ = tinymce.util.Tools.resolve("tinymce.Resource");
  const P_ = e => be(e, "init");
  var U_ = tinymce.util.Tools.resolve("tinymce.util.Tools");
  const W_ = Di("browse.files.event"),
    $_ = (e, t, o) => {
      const n = (e, t) => {
          t.stop();
        },
        ...
        i = sk.parts.field({
          ...
          buttonBehaviours: ca([
            ...
            V_(o.getOr([])),
            Ub.config({}),
            fw(() => t.checkUiComponentContext(e.context).shouldDisable),
            Ew(() => t.checkUiComponentContext(e.context))
          ])
        }),
        l = {
                ...
                (s = o),
                  (r = n.event.files) &&
                    ($u.setValue(
                      s,
                      ((e, t) => {
                        const o = U_.explode(t.getOption("images_file_types"));
                        return P(ne(e), e =>
                          R(o, t =>
    ...
    G_ = Di("alloy-fake-before-tabstop"),
    q_ = Di("alloy-fake-after-tabstop"),
    Y_ = e => ({
      dom: {
        tag: "div",
    ...
    J_ = (e, t) => {
      const o = t.element;
      Ca(o, G_) ? K_(e, !0) : Ca(o, q_) && K_(e, !1);
    },
    Q_ = e => $C(e, ["." + G_, "." + q_].join(","), T),
    Z_ = Di("update-dialog"),
    eT = Di("update-title"),
    tT = Di("update-body"),
    oT = Di("update-footer"),
    nT = Di("body-send-message"),
    sT = Di("dialog-focus-shifted"),
    rT = Mo().browser,
    aT = rT.isSafari(),
    iT = rT.isFirefox(),
    lT = aT || iT,
    cT = rT.isChromium(),
    dT = ({ scrollTop: e, scrollHeight: t, clientHeight: o }) =>
      Math.ceil(e) + o >= t,
    uT = (e, t) => e.scrollTo(0, "bottom" === t ? 99999999 : t),
    mT = (e, t, o) => {
      const n = e.dom;
      A.from(n.contentDocument).fold(o, e => {
        ...
        const s = ((e, t) => {
          ...
          r = () => {
            ...
            g(e) && (s ? uT(e, "bottom") : !s && lT && 0 !== o && uT(e, o));
          };
        aT && n.addEventListener("load", r, { once: !0 }),
          e.open(),
          e.write(t),
          e.close(),
          aT || r();
    ...
    pT = Di("toolbar.button.execute"),
    hT = Di("common-button-display-events"),
    fT = {
      [mr()]: [
        "disabling",
      ...
      [Cr()]: ["toolbar-button-events", hT],
      [kr()]: ["toolbar-button-events", "dropdown-events", "tooltipping"],
      [$s()]: ["focusing", "alloy.base.behaviour", hT]
    },
    bT = e => Mt(e.element, "width", It(e.element, "width")),
    vT = (e, t, o) =>
      dx(
        e,
        {
    ...
    xT = (e, t) => vT(e, t, []),
    yT = (e, t) => vT(e, t, [_h.config({})]),
    wT = (e, t, o) => ({
      dom: { tag: "span", classes: [`${t}__select-label`] },
      components: [dl(o.translate(e))],
      behaviours: ca([_h.config({})])
    }),
    ST = Di("update-menu-text"),
    CT = Di("update-menu-icon"),
    kT = (e, t, o, n) => {
      const s = en(b),
        r = e.text.map(e => Lb(wT(e, t, o.providers))),
        a = e.icon.map(e => Lb(yT(e, o.providers.icons))),
        i = (e, t) => {
        ...
        h = Lb(
          IC.sketch({
            ...
            dropdownBehaviours: ca([
              ...
              Ew(() => o.providers.checkUiComponentContext(e.context)),
              Dk.config({}),
              _h.config({}),
              ...e.tooltip
                .map(e =>
              ...
              Th(m, [
                Jr((t, o) => {
                  "listbox" !== e.listRole && bT(t);
                })
              ]),
              Th("update-dropdown-width-variable", [
                Wr(Sr(), (e, t) => IC.close(e))
              ]),
              Th("menubutton-update-display-text", [
                ...
                Wr(CT, (e, t) => {
                  a.bind(t => t.getOpt(e)).each(e => {
                    _h.set(e, [yT(t.event.icon, o.providers.icons)]);
                  });
                })
              ])
            ]),
                ...
                Wr(Lx, (e, t) => {
                  (e => {
                    const t = $u.getValue(e),
                      o = Ux(e).map($x);
                    IC.refetch(t).get(() => {
                      const e = gC.getCoupled(t, "sandbox");
                      o.each(t =>
                        Ux(e).each(e =>
                          ((e, t) => {
            ...
            fetch: t => vC(C(e.fetch, t))
          })
        );
      return h.asSpec();
    },
    OT = e => "separator" === e.type,
    _T = { type: "separator" },
    TT = (e, t) => {
      const o = ((e, t) => {
        const o = W(
        ...
        return o.length > 0 && OT(o[o.length - 1]) && o.pop(), o;
      })(r(e) ? e.split(" ") : e, t);
      return U(
        o,
        (e, o) => {
    ...
    ET = (e, t, o, n) => {
      const s = Di("primary-menu"),
        r = TT(e, o.shared.providers.menuItems());
      ...
      const a = (e =>
        ...
        i = HC(s, r.items, t, o, n.isHorizontalMenu, a),
        l = (e =>
          e.search.fold(
            () => ({ searchMode: "no-search" }),
            e => ({ searchMode: "search-with-results" })
          ))(n),
        c = le(r.menus, (e, n) => HC(n, e, t, o, !1, l)),
        d = xn(c, Ds(s, i));
      ...
      V(o, o =>
        AT(o)
          ? {
              ...
              active: o.value === n,
              onAction: () => {
                $u.setValue(e, o.value), Rr(e, dk, { name: t }), Bh.focus(e);
              }
            }
          : {
              type: "nestedmenuitem",
              text: o.text,
              getSubmenuItems: () => DT(e, t, o.items, n, s)
            }
      ),
    BT = (e, t) => se(e, e => (AT(e) ? Ce(e.value === t, e) : BT(e.items, t))),
    IT = Gm({
      name: "HtmlSelect",
      configFields: [
        rs("options"),
        ...
        HT(e, t.unit)
          ...
          .map(e => {
            return (
              (o = e),
              (n = t.unit),
              e => HT(e, n).map(e => ({ value: e * o, unit: n }))
            );
            var o, n;
          })
          .getOr(PT)
            ...
            Mk.config({
              ...
              validator: {
                validate: t => {
                  const o = $u.getValue(t),
                    n = e.validator(o);
                  return xC(!0 === n ? ln.value(o) : ln.error(n));
                },
        ...
        c = [
          ug.config({
            disabled: () =>
              e.disabled || t.checkUiComponentContext(e.context).shouldDisable,
            onDisabled: e => {
              sk.getField(e).each(ug.disable);
            },
            onEnabled: e => {
              sk.getField(e).each(ug.enable);
            }
          }),
          Ew(() => t.checkUiComponentContext(e.context))
        ];
    ...
    jT = e => e.dimension.property,
    GT = (e, t) => e.dimension.getDimension(t),
    qT = (e, t) => {
      const o = $T(e, t);
    ...
    KT = (e, t, o, n) => {
      o.setCollapsed(),
        Mt(e.element, jT(t), GT(t, e.element)),
        qT(e, t),
        YT(e, t),
        t.onStartShrink(e),
        t.onShrunk(e);
    ...
    JT = (e, t, o, n) => {
      const s = n.getOrThunk(() => GT(t, e.element));
      o.setCollapsed(), Mt(e.element, jT(t), s), Lt(e.element);
      const r = $T(e, t);
      Sa(r, t.growingClass),
    ...
    QT = (e, t, o) => {
      const n = GT(t, e.element);
      ("0px" === n ? KT : JT)(e, t, o, A.some(n));
    },
    ZT = (e, t, o) => {
      const n = $T(e, t),
        ...
        r = GT(t, e.element);
      XT(e, t);
      const a = GT(t, e.element);
      (s
        ? () => {
            Mt(e.element, jT(t), r), Lt(e.element);
          }
        : () => {
            YT(e, t);
          })(),
  ...
  var oE = Object.freeze({
      ...
      isGrowing: eE,
      isShrinking: tE,
      isTransitioning: (e, t, o) => eE(e, t) || tE(e, t),
      toggleGrow: (e, t, o) => {
        (o.isExpanded() ? QT : ZT)(e, t, o);
      },
      disableTransitions: qT,
      immediateGrow: (e, t, o) => {
        o.isExpanded() ||
          (XT(e, t),
          Mt(e.element, jT(t), GT(t, e.element)),
  ...
  const rE = ua({
      ...
      kT(
        {
          ...
          role: n,
          fetch: (t, n) => {
            const s = { pattern: e.search.isSome() ? NC(t) : "" };
            e.fetch(
              t => {
                n(
                  ET(t, hx.CLOSE_ON_EXECUTE, o, {
                    isHorizontalMenu: !1,
                    search: e.search
                  })
                );
          ...
          n.setActive(s),
            ...
            o.shared.getSink().each(o => {
              t()
                ...
                .each(t => {
                  mc(t.element),
                    Rr(t, pk, { name: e.name, value: e.storage.get() });
                });
            });
        },
        s = e => t => {
    ...
    mE = ({
      ...
      const a = e.menu.map(e => iE(e, "tox-mbtn", r, A.none(), o)),
        i = [cE(e.title)];
      return (
        dE(e, i, r),
        a.each(e => i.push(e)),
    ...
    pE = Di("directory-label-event-id"),
    hE = ({ directory: e, visible: t, noChildren: o, backstage: n }) => {
      const s = e.menu.map(e => iE(e, "tox-mbtn", n, A.none())),
        r = [
          {
            dom: { tag: "div", classes: ["tox-chevron"] },
            components: [
              ((a = n.shared.providers.icons), gE("chevron-right", a, []))
            ]
          },
          cE(e.title)
        ];
        ...
        behaviours: ca([
          ...
          Hh.config({
            ...
            onToggled: (e, o) => {
              ...
              var d;
              o ? rE.grow(r) : rE.shrink(r), _h.set(r, c);
            }
          })
        ])
      };
  ...
  const kE = ua({ fields: CE, name: "streaming", active: yE, state: SE }),
    OE = (e, t, o) => {
    ...
    TE = e => {
      _E(e, (e, t) => e.setSelectionRange(t.length, t.length));
    },
    EE = y("alloy.typeahead.itemexecute"),
    AE = y(
      [
        gs("lazySink"),
        rs("fetch"),
        ...
        gs("initialData"),
        gs("listRole"),
        ju("typeaheadBehaviours", [Bh, $u, kE, bh, Hh, gC]),
        ...
        overrides: e => ({
          ...
          onHighlightItem: (t, o, n) => {
            e.previewing.get()
              ...
              : e.lazyTypeaheadComp.get().each(t => {
                  e.model.populateFromBrowse && OE(e.model, t, n),
          ...
          onExecute: (t, o) =>
            e.lazyTypeaheadComp.get().map(e => (Rr(e, EE(), { item: o }), !0)),
          onHover: (t, o) => {
            e.previewing.set(!1),
              e.lazyTypeaheadComp.get().each(t => {
                e.model.populateFromBrowse && OE(e.model, t, o);
              });
          }
        })
      })
    ...
    DE = qm({
      ...
      factory: (e, t, o, n) => {
        const s = (t, o, s) => {
            e.previewing.set(!1);
            const r = gC.getCoupled(t, "sandbox");
            if (ku.isOpen(r))
          ...
          c = [
            ...
            kE.config({
              ...
              onStream: (t, o) => {
                const s = gC.getCoupled(t, "sandbox");
            ...
            bh.config({
              ...
              onEnter: t => {
                const o = gC.getCoupled(t, "sandbox"),
                  n = ku.isOpen(o);
                if (n && !e.previewing.get())
                  return i(o)
                    .bind(e => wg.getHighlighted(e))
                    .map(e => (Rr(t, EE(), { item: e }), !0));
                {
            ...
            Th(
              ...
              [
                ...
                ea(t => {
                  const o = b;
                  OC(e, a(t), t, n, o, ff.HighlightMenuAndItem).get(b);
                }),
                Wr(EE(), (t, o) => {
                  const n = gC.getCoupled(t, "sandbox");
                  OE(e.model, t, o.event.item),
                    Fr(t, br()),
          ...
          d = { [kr()]: [$u.name(), kE.name(), l], ...e.eventOrder };
        return {
          uid: e.uid,
          dom: zx(
            xn(e, {
        ...
        l = {
          buttonBehaviours: ca(
            [
              ...
              Ew(() => a.checkUiComponentContext(e.context)),
              Ub.config({}),
              ...r
                .map(e =>
                  Zb.config(
    ...
    RE = (e, t, o, n = [], s) => {
      const r = {
        ...
        a = e.icon.map(e => xT(e, o.icons)),
        i = Dw([a]);
      return FE(e, t, n, r, i, e.tooltip, o);
    },
    NE = e => {
      switch (e) {
        case "primary":
    ...
    zE = (e, t, o, n = [], s = []) => {
      const r = o.translate(e.text),
        ...
        d = e.icon.map(y(r));
      return FE(e, t, n, c, i, d, o);
    },
    VE = (e, t, o, n = [], s = []) => {
      const r = zE(e, A.some(t), o, n, s);
      return zb.sketch(r);
    },
    LE = (e, t) => o => {
      "custom" === t
        ? Rr(o, pk, { name: e, value: {} })
        : "submit" === t
          ? Fr(o, hk)
          : "cancel" === t
            ? Fr(o, gk)
    ...
    HE = (e, t, o) => {
      ...
      if (((e, t) => "togglebutton" === t)(0, t))
        return ((e, t, o) => {
          var n, s;
          const r = e.icon.map(e => yT(e, t.icons)).map(Lb),
    ...
    $E = (e, t) => (e => V(e, UE))(((e, t) => P(t, t => t.type === e))(e, t)),
    jE = e => $E("header", e.targets),
    GE = e => $E("anchor", e.targets),
    qE = e =>
      A.from(e.anchorTop)
        .map(e => WE("<top>", e))
        .toArray(),
    ...
    eA = {
      ...
      collection: ZE((e, t, o) => yk(e, t.shared.providers, o)),
      alertbanner: ZE((e, t) =>
        ((e, t) => {
          const o = ix(e.icon, t.icons);
          return ek.sketch({
            dom: {
              tag: "div",
                ...
                components: e.url
                  ? [
                      zb.sketch({
                        ...
                        action: t =>
                          Rr(t, pk, { name: "alert-banner", value: e.url }),
                        buttonBehaviours: ca([lx()])
                      })
                    ]
                  : void 0
              },
      ...
      iframe:
        ((TM = (e, t, o) =>
          ((e, t, o) => {
                ...
                return {
                  ...
                  setValue: (e, n) => {
                    if (o.get() !== n) {
                      const o = e.element,
                        s = () => St(o, "srcdoc", n);
                      t ? gT.fold(y(mT), e => e.throttle)(o, n, s) : s();
                    }
                    o.set(n);
                  }
                };
              })(o, e.streamContent),
              l = e.label.map(e => ck(e, t)),
              c = sk.parts.field({
                factory: {
                  sketch: e =>
                    X_(A.from(r), {
            ...
            return ak(l, c, ["tox-form__group--stretched"], []);
          })(e, t.shared.providers, o)),
        (e, t, o, n, s) => {
          const r = xn(t, { source: "dynamic" });
          return ZE(TM)(e, r, o, n, s);
        }),
      button: ZE((e, t) =>
        ((e, t) => {
          const o = LE(e.name, "custom");
          return (
            (n = A.none()),
            (s = sk.parts.field({
              factory: zb,
              ...zE(e, A.some(o), t, [V_(""), B_()])
            })),
            ak(n, s, [], [])
          );
          var n, s;
      ...
      colorinput: ZE((e, t, o) =>
        ((e, t, o, n) => {
          const s = sk.parts.field({
              factory: Vx,
              inputClasses: ["tox-textfield"],
              data: n,
              onSetValue: e => Mk.run(e).get(b),
              inputBehaviours: ca([
                ug.config({
                  disabled: () =>
                ...
                Ew(() => t.providers.checkUiComponentContext(e.context)),
                Ub.config({}),
                Mk.config({
                  ...
                  validator: {
                    ...
                    validate: e => {
                      const t = $u.getValue(e);
                      if (0 === t.length) return xC(ln.value(!0));
                      {
                        const e = Re("span");
            ...
            r = e.label.map(e => ck(e, t.providers)),
            a = (e, t) => {
              Rr(e, Ik, { value: t });
            },
            i = Lb(
                      ...
                      A.from(
                        PC(
                          xn(
                            ...
                            { movement: oC(e.columns, e.presets) }
                          )
                        )
                      )
                    ),
                  parts: { menu: Ix(0, 0, e.presets) }
                }))(
                {
                  dom: {
                    tag: "span",
      ...
      colorpicker: ZE((e, t, o) =>
        ((e, t, o) => {
          const n = e => "tox-" + e,
            s = D_(
              (e => t => (r(t) ? e.translate(L_[t]) : e.translate(t)))(t),
              n,
              t.tooltips.getConfig,
              (e, o, n = e, s = e) =>
                dx(
            ...
            a = Lb(
              s.sketch({
                ...
                onValidHex: e => {
                  Rr(e, pk, { name: "hex-valid", value: !0 });
                },
                onInvalidHex: e => {
                  Rr(e, pk, { name: "hex-valid", value: !1 });
                }
              })
            );
          return {
      ...
      dropzone: ZE((e, t, o) => $_(e, t.shared.providers, o)),
      grid: ZE((e, t) =>
        ((e, t) => ({
          dom: {
            tag: "div",
      ...
      listbox: ZE((e, t, o) =>
        ((e, t, o) => {
          const n = R(e.items, e => !AT(e)),
            s = t.shared.providers,
            r = o
              .bind(t => BT(e.items, t))
              .orThunk(() => te(e.items).filter(AT)),
            a = e.label.map(e => ck(e, s)),
            i = sk.parts.field({
              dom: {},
              factory: {
                sketch: o =>
                  kT(
                    {
                      ...
                      ariaLabel: e.label,
                      fetch: (o, s) => {
                        const r = DT(o, e.name, e.items, $u.getValue(o), n);
                        s(
                          ET(r, hx.CLOSE_ON_EXECUTE, t, {
                            isHorizontalMenu: !1,
                            search: A.none()
                          })
                        );
      ...
      sizeinput: ZE((e, t) =>
        ((e, t) => {
          ...
          const n = Di("ratio-event"),
            ...
            a = Ew(() => t.checkUiComponentContext(e.context)),
            ...
            g = zT.parts.field1(d([sk.parts.label(m("Width")), u(!0)])),
            p = zT.parts.field2(d([sk.parts.label(m("Height")), u(!1)]));
          return zT.sketch({
            dom: { tag: "div", classes: ["tox-form__group"] },
            components: [
              {
            ...
            coupledFieldBehaviours: ca([
              ug.config({
                disabled: r,
                onDisabled: e => {
                  zT.getField1(e).bind(sk.getField).each(ug.disable),
                    zT.getField2(e).bind(sk.getField).each(ug.disable),
                    zT.getLock(e).each(ug.disable);
                },
                onEnabled: e => {
                  zT.getField1(e).bind(sk.getField).each(ug.enable),
                    zT.getField2(e).bind(sk.getField).each(ug.enable),
                    zT.getLock(e).each(ug.enable);
                }
              }),
              Ew(() => t.checkUiComponentContext("mode:design")),
              Th("size-input-events2", [
                Wr(n, (e, t) => {
                  const n = t.event.isField1,
                    s = n ? zT.getField1(e) : zT.getField2(e),
                    r = n ? zT.getField2(e) : zT.getField1(e),
      ...
      slider: ZE((e, t, o) =>
        ((e, t, o) => {
          ...
          return f_.sketch({
            ...
            components: [n, s, r],
            sliderBehaviours: ca([B_(), Bh.config({})]),
            onChoose: (t, o, n) => {
              Rr(t, dk, { name: e.name, value: n });
            },
            onChange: (t, o, n) => {
              Rr(t, dk, { name: e.name, value: n });
            }
        ...
        ((e, t, o, n) => {
          const s = t.shared.providers,
            ...
            a = {
              ...
              inputClasses: ["tox-textfield"],
              sandboxClasses: ["tox-dialog__popups"],
              inputAttributes: { "aria-errormessage": KE, type: "url" },
              minChars: 0,
              responseTime: 0,
              fetch: n => {
                const s = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      t => {
                        const n = XE(
                          a,
                          (e => V(e, e => WE(e, e)))(o.getHistory(e))
                        );
                        return "file" === e
                          ? ((s = [
                              n,
                              XE(a, jE(t)),
                              XE(a, G([qE(t), GE(t), YE(t)]))
                            ]),
                            W(
                              s,
                              (e, t) =>
              ...
              onSetValue: (e, t) => {
                e.hasConfigured(Mk) && Mk.run(e).get(b);
              },
                ...
                Th("urlinput-events", [
                  Wr(Zs(), t => {
                    const o = tl(t.element),
                      n = o.trim();
                    n !== o && ol(t.element, n),
                      "file" === e.filetype && Rr(t, dk, { name: e.name });
                  }),
                  Wr(er(), t => {
                    Rr(t, dk, { name: e.name }), r(t);
                  }),
                  Wr(dr(), t => {
                    Rr(t, dk, { name: e.name }), r(t);
                  })
              ...
              parts: { menu: Ix(0, 0, "normal") },
              onExecute: (e, t, o) => {
                Rr(t, hk, {});
              },
              onItemExecute: (t, o, n, s) => {
                r(t), Rr(t, dk, { name: e.name });
              }
            },
            i = sk.parts.field({ ...a, factory: DE }),
            l = e.label.map(e => ck(e, s)),
            c = Lb(
              ((e, t, o = e, n = e) =>
                dx(
                  o,
          ...
          return sk.sketch({
            ...
            components: l.toArray().concat([
              {
                dom: { tag: "div", classes: ["tox-form__controls-h-stack"] },
                components: G([[g.asSpec()], u.map(() => p.asSpec()).toArray()])
              }
            ]),
            fieldBehaviours: ca([
              ug.config({
                disabled: () =>
                  ...
                  s.checkUiComponentContext(e.context).shouldDisable,
                onDisabled: e => {
                  sk.getField(e).each(ug.disable), p.getOpt(e).each(ug.disable);
                },
                onEnabled: e => {
                  sk.getField(e).each(ug.enable), p.getOpt(e).each(ug.enable);
                }
              }),
              Ew(() => s.checkUiComponentContext(e.context)),
              Th("url-input-events", [
                Wr(m, t => {
                  Jm.getCurrent(t).each(o => {
                    ...
                    u.each(n => {
                      n(s).get(n => {
                        $u.setValue(o, n), Rr(t, dk, { name: e.name });
                      });
                    });
                  });
                })
                ...
                Jr(s => {
                  o.getOpt(s).each(o => {
                    (P_(e)
                      ...
                      : H_.load(e.scriptId, e.scriptUrl).then(t =>
    ...
    tA = { field: (e, t) => t, record: y([]) },
    oA = (e, t, o, n, s) => {
      const r = xn(n, { shared: { interpreter: t => nA(e, t, o, r, s) } });
      return nA(e, t, o, r, s);
    },
    nA = (e, t, o, n, s) =>
      fe(eA, t.type).fold(
    ...
    sA = (e, t, o, n) => nA(tA, e, t, o, n),
    rA = "layout-inset",
    aA = e => e.x,
    iA = (e, t) => e.x + e.width / 2 - t.width / 2,
    lA = (e, t) => e.x + e.width - t.width,
    cA = e => e.y,
    dA = (e, t) => e.y + e.height - t.height,
    uA = (e, t) => e.y + e.height / 2 - t.height / 2,
    mA = (e, t, o) =>
      Ml(
        lA(e, t),
        dA(e, t),
    ...
    fA = (e, t, o) =>
      Ml(iA(e, t), cA(e), o.insetNorth(), Nl(), "north", Hl(e, { top: 2 }), rA),
    bA = (e, t, o) =>
      Ml(
        iA(e, t),
        dA(e, t),
    ...
    xA = (e, t, o) =>
      Ml(aA(e), uA(e, t), o.insetWest(), Vl(), "west", Hl(e, { left: 1 }), rA),
    yA = e => {
      switch (e) {
        case "north":
          return fA;
    ...
    wA = (e, t, o, n, s) => Tc(n).map(yA).getOr(fA)(e, t, o, n, s),
    SA = e => {
      switch (e) {
        case "north":
          return bA;
    ...
    CA = (e, t, o, n, s) => Tc(n).map(SA).getOr(fA)(e, t, o, n, s),
    kA = {
      valignCentre: [],
      alignCentre: [],
      alignLeft: [],
    ...
    AA = e => t => ({ type: "node", root: e(), node: t }),
    MA = (e, t, o, n) => {
      const s = kb(e),
        r = () => ze(e.getBody()),
        ...
        i = () => s || !n();
      return {
        inlineDialog: OA(a, t, i),
        inlineBottomDialog: _A(e.inline, a, o, i),
        banner: TA(a, t, i),
        cursor: EA(e, r),
        node: AA(r)
      };
    ...
    XA = e => e.innerText || e.textContent,
    KA = e =>
      (e => e && "A" === e.nodeName && void 0 !== (e.id || e.name))(e) && QA(e),
    JA = e => e && /^(H[1-6])$/.test(e.nodeName),
    QA = e =>
      (e => {
        let t = e;
        for (; (t = t.parentNode); ) {
          const e = t.contentEditable;
          if (e && "inherit" !== e) return GA(t);
        }
        return !1;
      })(e) && !qA(e),
    ZA = e => JA(e) && QA(e),
    eM = e => {
      ...
      return YA(
        "header",
        null !== (t = XA(e)) && void 0 !== t ? t : "",
        "#" + o,
        (e => (JA(e) ? parseInt(e.nodeName.substr(1), 10) : 0))(e),
        () => {
          e.id = o;
        }
      );
    ...
    tM = e => {
      const t = e.id || e.name,
        o = XA(e);
      return YA("anchor", o || "#" + t, "#" + t, 0, b);
    },
    oM = e => $A(e.title).length > 0,
    nM = e => {
      const t = (e => {
        const t = V(kd(ze(e), "h1,h2,h3,h4,h5,h6,a:not([href])"), e => e.dom);
        return t;
      })(e);
      return P((e => V(P(e, ZA), eM))(t).concat((e => V(P(e, KA), tM))(t)), oM);
    },
    sM = "tinymce-url-history",
    rM = e => r(e) && /^https?/.test(e),
    aM = e =>
      a(e) &&
      pe(e, e => {
        return !(l((t = e)) && t.length <= 5 && Y(t, rM));
        var t;
      }).isNone(),
    iM = () => {
      const e = CS.getItem(sM);
      if (null === e) return {};
      let t;
      try {
        t = JSON.parse(e);
        ...
        if (e instanceof SyntaxError)
          return (
            console.log("Local storage " + sM + " was not valid JSON", e), {}
          );
        throw e;
      }
      return aM(t)
        ? t
        : (console.log("Local storage " + sM + " was not valid format", t), {});
    },
    lM = e => {
      const t = iM();
      return fe(t, e).getOr([]);
    ...
    cM = (e, t) => {
      ...
      (o[t] = [e].concat(s).slice(0, 5)),
        (e => {
          ...
          CS.setItem(sM, JSON.stringify(e));
        })(o);
    },
    dM = e => !!e,
    uM = e => le(U_.makeMap(e, /[, ]/), dM),
    mM = e => A.from(Jf(e)),
    gM = e => A.from(e).filter(r).getOrUndefined(),
    pM = e => ({
      getHistory: lM,
      addToHistory: cM,
      getLinkInformation: () =>
        (e =>
          tb(e)
            ? A.some({
                targets: nM(e.getBody()),
                anchorTop: gM(ob(e)),
                anchorBottom: gM(nb(e))
              })
            : A.none())(e),
      ...
      getUrlPicker: t =>
        ((e, t) =>
          ((e, t) => {
            const o = (e => {
              const t = A.from(eb(e)).filter(dM).map(uM);
              return mM(e).fold(T, e => t.fold(E, e => re(e).length > 0 && e));
            })(e);
            return d(o) ? (o ? mM(e) : A.none()) : o[t] ? mM(e) : A.none();
          })(e, t).map(
            o => n =>
              vC(s => {
                const i = {
    ...
    wM = y([rs("dom"), ws("shell", !0), ju("toolbarBehaviours", [_h])]),
    SM = y([
      ym({
        name: "groups",
        overrides: () => ({ behaviours: ca([_h.config({})]) })
  ...
  const AM = y(Di("toolbar-height-change")),
    MM = {
    ...
    RM = (e, t) => {
      t
        ? (Sa(e, MM.fadeOutClass), ka(e, [MM.transitionClass, MM.fadeInClass]))
        : (Sa(e, MM.fadeInClass), ka(e, [MM.fadeOutClass, MM.transitionClass]));
    },
    NM = (e, t) => {
      const o = ze(e.getContainer());
      t ? (ya(o, DM), Sa(o, BM)) : (ya(o, BM), Sa(o, DM));
    },
    zM = (e, t) => {
      const o = nn(),
        n = t.getSink,
        ...
        a = e.inline
          ? []
          : [dc.config({ channels: { [AM()]: { onReceive: FM } } })];
      return [
        Bh.config({}),
        Oi.config({
          contextual: {
            ...
            onShown: e => {
              s(e => Oa(e, [MM.transitionClass, MM.fadeInClass])),
                o.get().each(t => {
                  ((e, t) => {
                    const o = tt(t);
                    hc(o)
          ...
          lazyViewport: t =>
            Rb(e, t.element).fold(
              () => {
                const o = Zo(),
                  n = Yf(e),
                  s = o.y + (IM(t, "top") && !Fb(e) ? n : 0),
                  r = o.height - (IM(t, "bottom") ? n : 0);
                return {
  ...
  const LM = Fn(
      [oy, as("items", Nn([Vn([ny, ms("items", Un)]), Un]))].concat(Iy)
    ),
    HM = [
      fs("text"),
      fs("tooltip"),
          ...
          const n = V(o, e => {
            const o = {
              ...
              n = UM(o)
                .mapError(e => Zn(e))
                .getOrDie();
            return iE(n, "tox-mbtn", t.backstage, A.some("menuitem"));
          });
          _h.set(e, n);
        }
      };
                    ...
                    e
                      ...
                      .each(o => {
                        e.getSystem()
                          .getByDom(t)
                          .each(e => {
                            IC.expand(e), IC.close(o), Bh.focus(e);
                          });
                      });
                });
              });
              ...
              t.event.prevFocus
                ...
                .each(o => {
                  t.event.newFocus
                    .bind(t => e.getSystem().getByDom(t).toOptional())
                    .each(e => {
                      IC.isOpen(o) && (IC.expand(e), IC.close(o));
                    });
                });
            })
          ]),
  ...
  const jM = "container",
    ...
    XM = {
      ...
      sketch: e => {
        const t = (() => {
            const e = [];
            return {
              slot: (t, o) => (e.push(t), Tm(jM, qM(t), o)),
              record: y(e)
            };
          })(),
          o = e(t),
          n = t.record(),
          s = V(n, e => vm({ name: e, pname: qM(e) }));
        return Um(jM, GM, s, YM, o);
      }
    },
    KM = Fn([by, vy, Ts("onShow", b), Ts("onHide", b), gy]),
    JM = e => ({ element: () => e.element.dom }),
    QM = (e, t) => {
      const o = V(re(t), e => {
        const o = t[e],
          n = Jn((e => Kn("sidebar", KM, e))(o));
        return {
          name: e,
          getApi: JM,
          onSetup: n.onSetup,
    ...
    ZM = e =>
      XM.sketch(t => ({
        ...
        components: QM(t, e),
        slotBehaviours: pw([Jr(e => XM.hideAllSlots(e))])
      })),
    eD = (e, t) => {
      St(e, "role", t);
    },
    tD = e =>
      Jm.getCurrent(e).bind(e =>
        rE.isGrowing(e) || rE.hasGrown(e)
          ? Jm.getCurrent(e).bind(e =>
              $(XM.getSlotNames(e), t => XM.isShowing(e, t))
            )
          : A.none()
      ),
    oD = Di("FixSizeEvent"),
  ...
  const aD = ua({
    ...
    iD = e => Jm.getCurrent(e).each(e => mc(e.element, !0)),
    lD = (e, t, o) => {
      const n = en(!1),
        s = nn(),
        r = o => {
          ...
          n.get() &&
            ...
            (o.preventDefault(), iD(t()), e.editorManager.setActive(e));
        };
      e.inline ||
        e.on("PreInit", () => {
    ...
    cD = (e, t, o) => ({ within: e, extra: t, withinWidth: o }),
    dD = (e, t, o) => {
      const n = W(
          e,
          (e, t) =>
    ...
    gD = (e, t, o) => {
      ...
      const s = Im(e, t, "primary"),
        r = gC.getCoupled(e, "overflowGroup");
      ...
      const l = ((e, t, o, n) => {
        const s = ((e, t, o) => {
          ...
          })(e, t, o).getOrThunk(() => dD(t, e - o(n), o)),
          r = s.within,
          a = s.extra,
          i = s.withinWidth;
        return 1 === a.length && a[0].width <= o(n)
          ? ((e, t, o) => {
              const n = uD(e.concat(t));
              return cD(n, [], o);
            })(r, a, i)
          : a.length >= 1
            ? ((e, t, o, n) => {
                const s = uD(e).concat([o]);
                return cD(s, uD(t), n);
              })(r, a, n, i)
            : ((e, t, o) => cD(uD(e), [], o))(r, 0, i);
      })(
        Kt(s.element),
        t.builtGroups.get(),
      ...
      0 === l.extra.length
        ? (_h.remove(s, r), o([]))
        : (mD(s, l.within), o(l.extra)),
        Vt(s.element, "visibility"),
        Lt(s.element),
        i.each(Bh.focus);
    },
    pD = y([
      ju("splitToolbarBehaviours", [gC]),
      ns("builtGroups", () => en([]))
    ]),
    hD = y(
      [
    ...
    fD = y([
      vm({ factory: CM, schema: wM(), name: "primary" }),
      xm({ schema: wM(), name: "overflow" }),
    ...
    yD = nn(),
    wD = (e, t) => {
      const o = gC.getCoupled(e, "toolbarSandbox");
    ...
    CD = (e, t, o, n, s) => {
      CM.setGroups(t, s), SD(e, t, o, n), Hh.on(e);
    },
    kD = qm({
      ...
      factory: (e, t, o, n) => ({
                  ...
                  ((e, t, o) => {
                    ...
                    return {
                      ...
                      behaviours: ca([
                        ...
                        ku.config({
                          onOpen: (s, r) => {
                            const a = yD.get().getOr(!1);
                            o.fetch().get(s => {
                              CD(e, r, o, t.layouts, s),
                                n.link(e.element),
                                a || bh.focusIn(r);
                            });
                          },
                        ...
                        dc.config({
                          channels: {
                            ...
                            ...Du({
                              doReposition: () => {
                                ku.getState(
                                  gC.getCoupled(e, "toolbarSandbox")
                                ).each(n => {
                                  SD(e, n, o, t.layouts);
                                });
                              }
        ...
        apis: {
          setGroups: (t, n) => {
            ku.getState(gC.getCoupled(t, "toolbarSandbox")).each(s => {
              CD(t, s, e, o.layouts, n);
            });
          },
          reposition: t => {
            ku.getState(gC.getCoupled(t, "toolbarSandbox")).each(n => {
              SD(t, n, e, o.layouts);
            });
          },
          toggle: e => {
          ...
          toggleWithoutFocusing: e => {
            ((e, t) => {
              yD.set(!0), wD(e, t), yD.clear();
            })(e, n);
          },
          getToolbar: e => ku.getState(gC.getCoupled(e, "toolbarSandbox")),
          isOpen: e => ku.isOpen(gC.getCoupled(e, "toolbarSandbox"))
        }
      }),
      configFields: vD(),
      partFields: xD(),
    ...
    OD = y([rs("items"), hi(["itemSelector"]), ju("tgroupBehaviours", [bh])]),
    _D = y([wm({ name: "items", unit: "item" })]),
    TD = qm({
      name: "ToolbarGroup",
      configFields: OD(),
      partFields: _D(),
    ...
    MD = qm({
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          apis: {
            setGroups: (t, o) => {
              e.builtGroups.set(V(o, t.getSystem().build)), AD(t, s, e);
            },
            refresh: t => AD(t, s, e),
            toggle: e => {
              s.getOpt(e).each(e => {
            ...
            toggleWithoutFocusing: e => {
              s.getOpt(e).each(kD.toggleWithoutFocusing);
            },
            isOpen: e => s.getOpt(e).map(kD.isOpen).getOr(!1),
            reposition: e => {
              s.getOpt(e).each(e => {
                kD.reposition(e);
              });
            },
            getOverflow: e => s.getOpt(e).bind(kD.getToolbar)
          },
          domModification: { attributes: { role: "group" } }
        };
      },
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          apis: {
            ...
            isOpen: t =>
              ((e, t) => Bm(e, t, "overflow").map(rE.hasGrown).getOr(!1))(t, e)
          },
          domModification: { attributes: { role: "group" } }
        };
      },
    ...
    VD = (e, t) => {
      const o = Jr(t => {
        const o = V(e.initGroups, zD);
        CM.setGroups(t, o);
      });
      return ca([
        vw(() => e.providers.checkUiComponentContext("any").shouldDisable),
        Ew(() => e.providers.checkUiComponentContext("any")),
        bh.config({
          mode: t,
          onEscape: e.onEscape,
    ...
    LD = e => {
      ...
      return {
        ...
        parts: {
          "overflow-group": ND({ title: A.none(), label: A.none(), items: [] }),
          "overflow-button": RE(
            {
              context: "any",
              name: "more",
    ...
    $D = {
      button: [...WD, ry, ls("type", ["button"])],
      togglebutton: [...WD, _s("active", !1), ls("type", ["togglebutton"])]
    },
    jD = [ls("type", ["group"]), Es("buttons", [], es("type", $D))],
    GD = es("type", { ...$D, group: jD }),
    qD = Fn([Es("buttons", [], GD), cs("onShow"), cs("onHide")]),
    YD = (e, t) =>
      ((e, t) => {
        var o, n;
        const s = "togglebutton" === e.type,
          r = e.icon.map(e => yT(e, t.icons)).map(Lb),
          a = {
            ...e,
            name: s
          ...
          i = NE(null !== (n = e.buttonType) && void 0 !== n ? n : "secondary"),
              ...
              "group" === o.type
                ? ((t = !0),
                  ((e, t) => ({
                    ...
                    components: V(e.buttons, e => YD(e, t))
                  }))(o, e.providers))
                : YD(o, e.providers)
            );
            return {
  ...
  const ZD = (e, t, o) =>
      ge(t, (t, n) => {
        ...
        return e.slot(
          ...
          QD.sketch({
            ...
            components: [
              ...(s.buttons.length > 0
                ? [QD.parts.header({ buttons: s.buttons, providers: o })]
                : []),
              QD.parts.pane({})
            ]
          })
    ...
    tB = e => $(XM.getSlotNames(e), t => XM.isShowing(e, t)),
    oB = (e, t, o) => {
      XM.getSlot(e, t).each(e => {
        QD.getPane(e).each(t => {
          var n;
  ...
  var nB = Gm({
    factory: (e, t) => {
      const o = {
        setViews: (e, o) => {
          _h.set(e, [eB(o, t.backstage.shared.providers)]);
        },
        whichView: e => Jm.getCurrent(e).bind(tB),
        toggleView: (e, t, o, n) =>
          Jm.getCurrent(e).exists(s => {
            const r = tB(s),
              a = r.exists(e => n === e),
              i = XM.getSlot(s, n).isSome();
            return (
              i &&
                (XM.hideAllSlots(s),
                a
                ...
                r.each(e => ((e, t) => oB(e, t, QD.getOnHide))(s, e))),
              i
            );
          })
      };
  ...
  const sB = fM.optional({
    ...
    aB = fM.optional({
      factory: {
        sketch: e => {
          const t = (e =>
            e.type === yf.sliding ? PD : e.type === yf.floating ? HD : UD)(e);
          return t({
            type: e.type,
            uid: e.uid,
            onEscape: () => (e.onEscape(), A.some(!0)),
    ...
    cB = fM.optional({ name: "socket", schema: [rs("dom")] }),
    dB = fM.optional({
      factory: {
        sketch: e => ({
          uid: e.uid,
          ...
          components: [
            {
              ...
              behaviours: ca([
                ...
                rE.config({
                  ...
                  onShrunk: e => {
                    Jm.getCurrent(e).each(XM.hideAllSlots), Fr(e, nD);
                  },
                  onGrown: e => {
                    Fr(e, nD);
                  },
                  onStartGrow: e => {
                    Rr(e, oD, { width: Rt(e.element, "width").getOr("") });
                  },
                  onStartShrink: e => {
                    Rr(e, oD, { width: Kt(e.element) + "px" });
                  }
                }),
                _h.config({}),
                Jm.config({
  ...
  var pB = qm({
    ...
    factory: (e, t, o) => {
      ...
      const s = e => {
          Cl(e, ".tox-statusbar").each(e => {
            "none" === It(e, "display") && "true" === kt(e, "aria-hidden")
              ? (Vt(e, "display"), Tt(e, "aria-hidden"))
              : (Mt(e, "display", "none"), St(e, "aria-hidden", "true"));
          });
        },
        a = {
          getSocket: t => hM.getPart(t, e, "socket"),
          setSidebar: (t, o, n) => {
            hM.getPart(t, e, "sidebar").each(e =>
              ((e, t, o) => {
              ...
              ((e, t) => {
                Jm.getCurrent(e).each(o => {
                  Jm.getCurrent(o).each(n => {
                    rE.hasGrown(o)
                      ? XM.isShowing(n, t)
                        ? (rE.shrink(o), eD(e.element, "presentation"))
                        : (XM.hideAllSlots(n),
                          XM.showSlot(n, t),
                          eD(e.element, "region"))
                      : (XM.hideAllSlots(n),
          ...
          whichSidebar: t => hM.getPart(t, e, "sidebar").bind(tD).getOrNull(),
          getHeader: t => hM.getPart(t, e, "header"),
          getToolbar: t => hM.getPart(t, e, "toolbar"),
          setToolbar: (t, o) => {
            hM.getPart(t, e, "toolbar").each(e => {
              const t = V(o, zD);
              e.getApis().setGroups(e, t);
            });
          },
          setToolbars: (t, o) => {
            hM.getPart(t, e, "multiple-toolbar").each(e => {
              const t = V(o, e => V(e, zD));
              yM.setItems(e, t);
            });
          },
          refreshToolbar: t => {
            hM.getPart(t, e, "toolbar").each(e => e.getApis().refresh(e));
          },
          ...
          isToolbarDrawerToggled: t =>
            hM
              ...
              .getOr(!1),
          getThrobber: t => hM.getPart(t, e, "throbber"),
          focusToolbar: t => {
            hM.getPart(t, e, "toolbar")
              .orThunk(() => hM.getPart(t, e, "multiple-toolbar"))
              .each(e => {
                bh.focusIn(e);
              });
          },
          setMenubar: (t, o) => {
            hM.getPart(t, e, "menubar").each(e => {
              $M.setMenus(e, o);
            });
          },
          focusMenubar: t => {
          ...
          setViews: (t, o) => {
            hM.getPart(t, e, "viewWrapper").each(e => {
              nB.setViews(e, o);
            });
          },
          toggleView: (t, o) =>
            hM.getPart(t, e, "viewWrapper").exists(e =>
              nB.toggleView(
                e,
                () => a.showMainView(t),
                () => a.hideMainView(t),
          ...
          whichView: t =>
            hM.getPart(t, e, "viewWrapper").bind(nB.whichView).getOrNull(),
          hideMainView: t => {
            (n = a.isToolbarDrawerToggled(t)),
              n && a.toggleToolbarDrawer(t),
              hM.getPart(t, e, "editorContainer").each(e => {
                const t = e.element;
    ...
    partFields: [iB, sB, aB, rB, cB, dB, lB, uB, mB, gB],
    apis: {
  ...
  const hB = {
    ...
    bB = (e, t) => {
      const o = { ...hB, ...t.menus },
        ...
        i = V(a, n => {
          ...
          })({ title: s.title, items: fB(s.items) }, t, e);
        });
      return P(
        i,
        e =>
    ...
    vB = (e, t, o) => (e.on("remove", () => o.unload(t)), o.load(t)),
    xB = (e, t, o, n) => (
      e.on("remove", () => n.unloadRawCss(t)), n.loadRawCss(t, o)
    ),
    yB = e => A.from(tinymce.Resource.get(e)).filter(r),
    wB = (e, t, o = "") => {
      const n = (e => {
          const t = pb(e);
    ...
    SB = (e, t) => {
      ...
      switch (n._kind) {
        case "load-raw":
          const { key: t, css: s } = n;
          return xB(e, t, s, o), Promise.resolve();
    ...
    kB = (e, t) =>
      (async (e, t) => {
        ...
        if (
          (await ((e, t, o) => {
            const n = wB(e, t ? "content.inline" : "content", o);
            switch (n._kind) {
              case "load-raw":
                const { key: s, css: r } = n;
                return (
                  t
                    ? xB(e, s, r, e.ui.styleSheetLoader)
                    : e.on("PostRender", () => {
                        xB(e, s, r, e.dom.styleSheetLoader);
                      }),
                  Promise.resolve()
                );
              case "load-stylesheet":
          ...
          return Promise.all([SB(t, o), CB(t, o)]).then();
      })(e, t).then(
        (e => {
          const t = () => {
            (e._skinLoaded = !0),
    ...
    AB = (e, t) => {
      const o = t.dataset,
        n =
          "basic" === o.type
            ? () => V(o.data, e => PA(e, t.isSelectedFor, t.getPreviewFor))
            : o.getData;
      return { items: EB(e, t), getStyleItems: n };
    },
    MB = (e, t, o, n, s, r) => {
      const { items: a, getStyleItems: i } = AB(t, o),
        l = en(o.tooltip);
      return kT(
        {
          context: "mode:design",
          ...
          onSetup: t => {
            const r = o => t.setTooltip(TB(e, n(o.value), o.value));
            return (
              e.on(s, r),
              bS(
                yS(e, "NodeChange", t => {
  ...
  const BB = (e, t, o) => {
    ...
    NB = e => {
      ...
      return {
        ...
        onAction: t => () =>
          $(RB, e => e.format === t.format).each(t => e.execCommand(t.command)),
        updateText: t => {
          const o = $(RB, t => e.formatter.match(t.format)).fold(y(FB), e =>
            e.title.toLowerCase()
          );
          Rr(t, CT, { icon: `align-${o}` }),
            ((e, t) => {
    ...
    LB = "Paragraph",
    HB = e => {
      const t = BB(e, "block_formats", DB.SemiColon);
      return {
        tooltip: TB(e, VB(), LB),
        text: A.some(LB),
        icon: A.none(),
        ...
        onAction: wS(e),
        updateText: o => {
          const n = zB(e, () => t.data).fold(y(LB), e => e.title);
          Rr(o, ST, { text: n }),
            ((e, t) => {
    ...
    jB = (e, t) => t.length > 0 && Y(t, t => e.indexOf(t.toLowerCase()) > -1),
    GB = e => {
      const t = () => {
          const t = e => (e ? $B(e)[0] : ""),
        ...
        o = BB(e, "font_family_formats", DB.SemiColon);
      return {
        tooltip: TB(e, PB(), UB),
        text: A.some(UB),
        icon: A.none(),
    ...
    XB = (e, t) =>
      A.from(YB.exec(e)).bind(e => {
        const o = Number(e[1]),
          n = e[2];
        return ((e, t) => R(t, t => R(qB[t], t => e === t)))(n, t)
    ...
    nI = e => {
      const t = () => {
        ...
        o = y(A.none),
        n = BB(e, "font_size_formats", DB.Space);
      return {
        tooltip: TB(e, JB(), QB),
        text: A.some(QB),
        icon: A.none(),
          ...
          const n = e =>
              NA(e)
                ...
                : zA(e)
                  ...
                  : [],
            s = q(HA(e), n),
            r = zB(e, y(s)).fold(y({ title: o, tooltipLabel: "" }), e => ({
              title: e.title,
              tooltipLabel: e.title
            }));
          Rr(t, ST, { text: r.title }),
            ((e, t) => {
    ...
    aI = y(
      [
        ...
        rs("dom"),
        bi("onOpen"),
        ju("splitDropdownBehaviours", [gC, bh, Bh]),
        ws("matchWidth", !1),
        ws("useMinWidth", !1),
        ws("eventOrder", {}),
        gs("role"),
    ...
    dI = qm({
      ...
      factory: (e, t, o, n) => {
        const s = e => {
          ...
          r = t => {
            OC(e, w, t, n, s, ff.HighlightMenuAndItem).get(b);
          },
          a = t => {
    ...
    gI = (e, t) => e.map(e => ({ "aria-label": t.translate(e) })).getOr({}),
    pI = Di("focus-button"),
    hI = (e, t, o, n, s, r, a) => {
      const i = t.map(e => Lb(wT(e, "tox-tbtn", s))),
        l = e.map(e => Lb(yT(e, s.icons)));
      return {
        dom: {
          tag: "button",
          classes: ["tox-tbtn"].concat(t.isSome() ? ["tox-tbtn--select"] : []),
          attributes: { ...gI(o, s), ...(g(a) ? { "data-mce-name": a } : {}) }
        },
        components: Dw([l.map(e => e.asSpec()), i.map(e => e.asSpec())]),
        eventOrder: {
          [$s()]: ["focusing", "alloy.base.behaviour", hT],
          [Cr()]: [hT, "toolbar-group-button-events"],
          [kr()]: [hT, "toolbar-group-button-events", "tooltipping"]
        },
        buttonBehaviours: ca(
          [
            vw(() => s.checkUiComponentContext(r).shouldDisable),
            Ew(() => s.checkUiComponentContext(r)),
            Th(hT, [
              Jr((e, t) => bT(e)),
              Wr(ST, (e, t) => {
              ...
              Wr(CT, (e, t) => {
                l.bind(t => t.getOpt(e)).each(e => {
                  _h.set(e, [yT(t.event.icon, s.icons)]);
                });
              }),
              Wr($s(), (e, t) => {
                t.event.prevent(), Fr(e, pI);
              })
            ])
          ].concat(n.getOr([]))
        )
    ...
    fI = (e, t, o, n) => {
      var s;
      const r = en(b),
        a = hI(e.icon, e.text, e.tooltip, A.none(), o, e.context, n);
      return zb.sketch({
        dom: a.dom,
        ...
        buttonBehaviours: {
          ...ca(
            [
              Th("toolbar-button-events", [
                ...
                ea((e, t) => {
                  xw(
                    ...
                    Rr(e, pT, { buttonApi: t }), i.onAction(t);
                  });
                })),
                yw(t, r),
                ww(t, r)
              ...
              Ew(() => o.checkUiComponentContext(e.context))
            ].concat(t.toolbarButtonBehaviours)
          ),
          [hT]:
            null === (s = a.buttonBehaviours) || void 0 === s ? void 0 : s[hT]
        }
      });
      var i;
    },
        ...
        A.from(
          PC(
            xn(
              ...
              {
                movement: oC(t.columns, t.presets),
                menuBehaviours: pw(
                  "auto" !== t.columns
                    ? []
                    : [
                        Jr((e, o) => {
                          gw(e, 4, Tx(t.presets)).each(
    ...
    SI = {
      button: wI(Ry, (e, t, o, n) =>
        ((e, t, o) => bI(e, t, [], o))(e, t.shared.providers, n)
      ),
      togglebutton: wI(Vy, (e, t, o, n) =>
        ((e, t, o) => vI(e, t, [], o))(e, t.shared.providers, n)
      ),
      menubutton: wI(UM, (e, t, o, n) => iE(e, "tox-tbtn", t, A.none(), !1, n)),
      splitbutton: wI(
        e => Kn("SplitButton", WM, e),
        (e, t, o, n) =>
          ((e, t, o) => {
            ...
            return dI.sketch({
              ...
              toggleClass: "tox-tbtn--enabled",
              lazySink: t.getSink,
              fetch: xI(s, e, t.providers),
              parts: { menu: Ix(0, e.columns, e.presets) },
              components: [
                dI.parts.button(
                  hI(
                    e.icon,
                    ...
                    A.some([
                      ...
                      vw(T),
                      Ew(y({ contextType: "any", shouldDisable: !1 }))
                    ]),
                    t.providers,
                    e.context
                  )
                ...
                dI.parts.arrow({
                  dom: {
                    ...
                    innerHtml: ix("chevron-down", t.providers.icons)
                  },
                  buttonBehaviours: ca([
                    bw(T),
                    Ew(y({ contextType: "any", shouldDisable: !1 }))
      ...
      grouptoolbarbutton: wI(
        e => Kn("GroupToolbarButton", LM, e),
        (e, t, o, n) => {
          ...
          if (Uf(o) === yf.floating)
            return ((e, t, o, n, s) => {
              const r = t.shared,
                ...
                l = [
                  Th("toolbar-group-button-events", [yw(i, a), ww(i, a)]),
                  ...e.tooltip
                    .map(e =>
                      Zb.config(
                        t.shared.providers.tooltips.getConfig({
    ...
    CI = {
      styles: (e, t) => {
        ...
        return MB(e, t, rI(e, o), sI, "StylesTextUpdate", "styles");
      },
      fontsize: (e, t) => MB(e, t, nI(e), JB, "FontSizeTextUpdate", "fontsize"),
      fontsizeinput: (e, t) =>
        ((e, t, o, n) => {
          let s = A.none();
          const r = yS(e, "NodeChange SwitchMode DisabledStateChange", t => {
              const n = t.getComponent();
              (s = A.some(n)),
            ...
            h = (o, n, s, r) => {
              const i = en(b),
                ...
                c = Di("altExecuting"),
                d = yS(e, "NodeChange SwitchMode DisabledStateChange", t => {
              ...
              return zb.sketch({
                ...
                components: [xT(n, t.shared.providers.icons)],
                buttonBehaviours: ca([
                  ug.config({}),
                  Zb.config(
                  ...
                  Th(c, [
                    yw({ onSetup: d, getApi: a }, i),
                    ww({ getApi: a }, i),
                    Wr(Js(), (e, t) => {
                      (t.event.raw.keyCode !== KB.space() &&
                        t.event.raw.keyCode !== KB.enter()) ||
                        ug.isDisabled(e) ||
                        o(!1);
                    }),
                    Wr(tr(), u),
          ...
          (e => {
            ...
            return {
              updateInputValue: e => Rr(e, ST, { text: t() }),
              onAction: (t, o) =>
                e.execCommand("FontSize", !1, t, { skip_focus: !o }),
              getNewValue: (o, n) => {
                XB(o, ["unsupportedLength", "empty"]);
                const s = t(),
                  r = XB(o, ["unsupportedLength", "empty"]).or(
                    XB(s, ["unsupportedLength", "empty"])
                  ),
      ...
      fontfamily: (e, t) =>
        MB(e, t, GB(e), PB, "FontFamilyTextUpdate", "fontfamily"),
      blocks: (e, t) => MB(e, t, HB(e), VB, "BlocksTextUpdate", "blocks"),
      align: (e, t) => MB(e, t, NB(e), IB, "AlignTextUpdate", "align")
    },
    kI = (e, t, o, n) => {
      const s = (e => {
          const t = e.toolbar,
          ...
          return !1 === t
            ...
            : void 0 === t || !0 === t
              ? (e => {
                  const t = V(yI, t => {
                    const o = P(t.items, t => be(e, t) || be(CI, t));
            ...
            0 === s.trim().length
              ...
              : ((e, t, o, n, s, r) =>
                  fe(t, o.toLowerCase())
                    ...
                    .fold(
                      () => fe(CI, o.toLowerCase()).map(t => t(e, s)),
                      t =>
    ...
    OI = (e, t, o, n) => {
      ...
      if (f(a, r)) {
        const t = a.map(t => {
          ...
          return kI(e, s, n, A.none());
        });
        pB.setToolbars(s, t);
      } else pB.setToolbar(s, kI(e, o, n, A.none()));
    },
    _I = Mo(),
    TI = _I.os.isiOS() && _I.os.version.major <= 12;
  var EI = Object.freeze({
    ...
    render: (e, t, o, n, s) => {
      ...
      uu(d, r.mothership),
        ...
        e.on("PostRender", () => {
          pB.setSidebar(l, o.sidebar, db(e));
        }),
        e.on("SkinLoaded", () => {
          OI(e, t, o, n),
            i.set(e.getWin().innerWidth),
            pB.setMenubar(l, bB(e, o)),
            pB.setViews(l, o.views),
            ((e, t) => {
              ...
              const r = e.getDoc().documentElement,
                ...
                l = () => {
                  ...
                  (t.left === s.innerWidth && t.top === s.innerHeight) ||
                    (a.set(jt(s.innerWidth, s.innerHeight)), gS(e));
                },
                c = () => {
                  const t = e.getDoc().documentElement,
                    o = i.get();
                  (o.left === t.offsetWidth && o.top === t.offsetHeight) ||
                    (i.set(jt(t.offsetWidth, t.offsetHeight)), gS(e));
                },
                d = t => {
                  ((e, t) => {
      ...
      Tw(e, t),
        ...
        e.addQueryValueHandler("ToggleSidebar", () => {
          var e;
          return null !== (e = pB.whichSidebar(l)) && void 0 !== e ? e : "";
        }),
        e.addCommand("ToggleView", (t, o) => {
          if (pB.toggleView(l, o)) {
            const t = l.element;
            r.mothership.broadcastOn([Ou()], { target: t }),
              ...
              c(pB.whichView(l)) &&
                (e.focus(), e.nodeChanged(), pB.refreshToolbar(l)),
              (e => {
        ...
        e.addQueryValueHandler("ToggleView", () => {
          var e;
          return null !== (e = pB.whichView(l)) && void 0 !== e ? e : "";
        });
      const g = Uf(e);
      (g !== yf.sliding && g !== yf.floating) ||
        e.on("ResizeWindow ResizeEditor ResizeContent", () => {
          ...
          o !== i.get() &&
            (pB.refreshToolbar(t.mainUi.outerContainer), i.set(o));
        });
      const p = {
        setEnabled: e => {
          _w(t, e ? "setEnabled" : "setDisabled");
        },
  ...
  const AI = e =>
    ...
    BI = e => {
      const t = Bf(e),
        o = If(e),
        n = Rf(e);
      return AI(t).map(e => DI(e, o, n));
    },
    { ToolbarLocation: II, ToolbarMode: FI } = Mb,
    RI = (e, t, o, n, s) => {
      const { mainUi: r, uiMotherships: a } = o,
        ...
        x = o => {
          ...
          if ((p && pB.refreshToolbar(r.outerContainer), !l)) {
            const o = Po(),
              i = Ce(n.left !== o.left, n);
            ((o, n) => {
              s.on(s => {
                const a = pB.getToolbar(r.outerContainer),
                  i = b(a),
                  l = Ko(t),
          ...
          s.get().exists(o => {
            const n = u.getDockingMode(),
              a = (o => {
                switch ($f(e)) {
                  case II.auto:
                    const e = pB.getToolbar(r.outerContainer),
                      n = b(e),
                      s = Ut(o.element) - n,
                      a = Ko(t);
                    if (a.y > s) return "top";
  ...
  var zI = Object.freeze({
    ...
    render: (e, t, o, n, s) => {
      ...
      const d = () => {
        ...
        a.set(pB.getHeader(r.outerContainer).getOrDie());
        const s = Ob(e);
        Eb(e)
        ...
        const d = () => {
          OI(e, t, o, n),
            pB.setMenubar(r.outerContainer, bB(e, o)),
            l.show(),
            ((e, t, o, n) => {
              const s = en(NI(t, o.isPositionedAtTop())),
                r = n => {
                  const { pos: r, bounds: a } = NI(t, o.isPositionedAtTop()),
              ...
              let a = 0;
              const i = j_(() => o.update(Oi.refresh), 33);
              e.on("ScrollWindow", () => {
                const e = Po().left;
  ...
  const VI = "contexttoolbar-hide",
    ...
    HI = Di("forward-slide"),
    PI = Di("backward-slide"),
    UI = Di("change-slide-event"),
    WI = "tox-pop--resizing",
    $I = (e, t) => {
      const o = nn();
      return {
        ...
        hide: () => {
          o.isSet() || o.set($u.getValue(e)), Fr(e, fr());
        },
        back: () => {
          o.isSet() || o.set($u.getValue(e)), Fr(e, PI);
        },
            ...
            (e => "contextformtogglebutton" === e.type)(t)
              ? ((e, t, o) => {
                  const { primary: n, ...s } = t.original,
                    r = Jn(Vy({ ...s, type: "togglebutton", onAction: b }));
                  return vI(r, o, [jI(e, t)]);
                })(e, t, o)
              : ((e, t, o) => {
                  const { primary: n, ...s } = t.original,
                    r = Jn(Ry({ ...s, type: "button", onAction: b }));
                  return bI(r, o, [jI(e, t)]);
                })(e, t, o))(e, t, o)
        )
      );
      return {
    ...
    qI = (e, t, o) => {
      ...
      const a = Di("ratio-event"),
        ...
        x = v(zT.parts.field1(g([sk.parts.label(f("Width:")), h(!0)]))),
        y = v(zT.parts.field2(g([sk.parts.label(f("Height:")), h(!1)]))),
        w = en(b),
        S = [yw({ onSetup: e.onSetup, getApi: i }, w), ww({ getApi: i }, w)];
      return zT.sketch({
        dom: { tag: "div", classes: ["tox-context-form__group"] },
          ...
          Th("size-input-toolbar-events2", [
            Wr(a, (e, t) => {
              const o = t.event.isField1,
                n = o ? zT.getField1(e) : zT.getField2(e),
                s = o ? zT.getField2(e) : zT.getField1(e),
                a = n.map($u.getValue).getOr(""),
                i = s.map($u.getValue).getOr("");
              r = UT(a, i);
            }),
            Wr(uk, t => e.onInput($I(t))),
            ...S
          ])
        ])
      });
      ...
      const n = en(b),
        ...
        r = sk.parts.field({
          ...
          inputBehaviours: ca([
            ...
            Th("slider-events", [
              yw(
                { onSetup: e.onSetup, getApi: $I, onBeforeSetup: bh.focusIn },
                n
              ),
              ww({ getApi: $I }, n),
              Wr(Zs(), t => {
    ...
    KI = (e, t, o) => {
      const n = en(b),
        ...
        r = {
          ...e.placeholder.map(e => ({ placeholder: t.translate(e) })).getOr({})
        },
        a = sk.parts.field({
          factory: Vx,
              ...
              yw(
                {
                  onSetup: e.onSetup,
                  getApi: e =>
                    Sl(e.element, ".tox-toolbar")
                      .bind(e => Ol(e, "button:enabled"))
                      .fold(
                        () => $I(e),
                        t => $I(e, t)
                      ),
    ...
    QI = (e, t) => {
      switch (e.type) {
        case "contextform":
          return JI(C(KI, e), e, t);
        case "contextsliderform":
          return JI(C(XI, e), e, t);
        case "contextsizeinputform":
          return JI(C(qI, e), e, t);
      }
    },
    ZI = (e, t, o) => t.bottom - e.y >= o && e.bottom - t.y >= o,
    eF = e => {
      const t = (e => {
        const t = e.getBoundingClientRect();
    ...
    nF = { maxHeightFunction: Lc(), maxWidthFunction: bD() },
    sF = e => "node" === e,
    rF = (e, t, o, n, s) => {
      const r = eF(e),
      ...
      return ((e, t) => {
        ...
        : a
          ? ((e, o) => {
              ...
              Mt(e, "position", o);
              const a = ZI(r, Ko(t), -20) && !n.isReposition() ? CA : wA;
              return s.each(t => Mt(e, "position", t)), a;
            })(t, n.getMode())
          : ("fixed" === n.getMode() ? s.y + Po().top : s.y) + (Ut(t) + 12) <=
              r.y
            ? fA
            : bA;
    },
    aF = (e, t, o, n) => {
      const s = t => (n, s, r, a, i) => ({
          ...rF(e, a, t, o, i)({ ...n, y: i.y, height: i.height }, s, r, a, i),
          alwaysFit: !0
        }),
        r = e => (sF(n) ? [s(e)] : []);
      return t
      ...
      return (
        L(i, i => {
          ...
          "contextsizeinputform" === l.type
            ? ((e, i) => {
                const l = Jn(Kn("ContextForm", Yy, i));
                (o[e] = l),
                  l.launch.map(o => {
                    r["form:" + e] = {
                      ...i.launch,
            ...
            : "contexttoolbar" === l.type &&
              ((e, t) => {
                var o;
                ((o = t), Kn("ContextToolbar", Xy, o)).each(o => {
      ...
      const s = n.backstage,
        ...
        u = pl(
          (e => {
                ...
                Th("context-toolbar-events", [
                  Kr(nr(), (e, t) => {
                    "width" === t.event.raw.propertyName &&
                      (Sa(e.element, WI), Vt(e.element, "width"));
                  }),
                  Wr(UI, (e, t) => {
                    const o = e.element;
                    Vt(o, "width");
                    ...
                    e.onBack(),
                      oe(t.get()).each(e => {
                        t.set(t.get().slice(0, t.get().length - 1)),
                          Rr(o, UI, { contents: hl(e.bar), focus: e.focus });
                      });
                  })
                ]),
                bh.config({
            ...
            sink: o,
            onEscape: () => (e.focus(), fS(e), A.some(!0)),
            onHide: () => {
              fS(e);
            },
            onBack: () => {
              ...
              o = xe(d.get(), "node")
                ? ((e, t) =>
                    t
                      .filter(e => vt(e) && $e(e))
                      .map(Jo)
                      .getOrThunk(() => eF(e)))(e, l.get())
                : eF(e);
            return t.height <= 0 || !ZI(o, t, 0.01);
          }
          return !0;
        },
        h = () => {
              ...
              V(t, t => {
                return "contexttoolbar" === t.type
                  ? ((t, o) =>
                      ...
                      s,
                      ((o = t),
                      { ...o, items: r(o.items) ? o.items : V(o.items, Ky) })
                    )
                  : ((e, t) => QI(e, t))(t, a.providers);
                var o;
              })
            );
          return UD({
        ...
        w = (t, n) => {
          ...
          const f = u.element;
          Vt(f, "display"),
            (e => xe(we(e, l.get(), Ze), !0))(n) || (Sa(f, cF), Qd.reset(o, u)),
            xf.showWithinBounds(
              u,
              v(s),
              { anchor: h, transition: { classes: [cF], mode: "placement" } },
              () => A.some(m())
            ),
        ...
        e.on("remove", h),
          ...
          e.on("contexttoolbar-show", t => {
            ...
            fe(o.lookupTable, t.toolbarKey).each(o => {
              w([o], Ce(t.target !== e, t.target)), LI(u);
            });
          }),
          e.on("focusout", t => {
            Sf.setEditorTimeout(
    ...
    pF = (e, t) => o => {
      ...
      return (
        ...
        bS(() => e.off("PastePlainTextToggle", n), vS(e)(o))
      );
    },
    hF = (e, t) => () => {
    ...
    bF = (e, t) =>
      yS(e, "Undo Redo AddUndo TypingUndo ClearUndos SwitchMode", o => {
      ...
      (e => {
        ...
        (e => {
          ...
          const t = HS(e),
            ...
            n = en(t),
            s = en(o);
          JS(e, "forecolor", "forecolor", n),
            JS(e, "backcolor", "hilitecolor", s),
            QS(e, "forecolor", "forecolor", "Text color", n),
            QS(e, "backcolor", "hilitecolor", "Background color", s);
        })(e),
        (e => {
          (e => {
            e.ui.registry.addButton("visualaid", {
              tooltip: "Visual aids",
              text: "Visual aids",
              onAction: SS(e, "mceToggleVisualAid"),
              context: "any"
            });
          })(e),
            (e => {
        ...
        (e => {
          (e => {
            e.ui.registry.addButton("outdent", {
              ...
              icon: "outdent",
              onSetup: gF(e),
              onAction: SS(e, "outdent")
            }),
              e.ui.registry.addButton("indent", {
                tooltip: "Increase indent",
                icon: "indent",
                onSetup: vS(e),
                onAction: SS(e, "indent")
              });
          })(e);
        })(e),
        mF(e),
    ...
    yF = e => (r(e) ? e.split(/[ ,]/) : e),
    wF = e => t => t.options.get(e),
    SF = wF("contextmenu_never_use_native"),
    CF = wF("contextmenu_avoid_overlap"),
    kF = e => {
      const t = e.ui.registry.getAll().contextMenus,
        o = e.options.get("contextmenu");
      return e.options.isSet("contextmenu") ? o : P(o, e => be(t, e));
    },
    OF = (e, t) => ({ type: "makeshift", x: e, y: t }),
    _F = e => "longpress" === e.type || 0 === e.type.indexOf("touch"),
    TF = (e, t) =>
      "contextmenu" === t.type || "longpress" === t.type
        ? e.inline
          ? (e => {
              if (_F(e)) {
                const t = e.touches[0];
                return OF(t.pageX, t.pageY);
              }
              return OF(e.pageX, e.pageY);
            })(t)
          : ((e, t) => {
              const o = Cf.DOM.getPos(e);
              return ((e, t, o) => OF(e.x + t, e.y + o))(t, o.x, o.y);
            })(
              e.getContentAreaContainer(),
              (e => {
                if (_F(e)) {
                  const t = e.touches[0];
                  return OF(t.clientX, t.clientY);
                }
                return OF(e.clientX, e.clientY);
              })(t)
            )
        : EF(e),
    EF = e => ({ type: "selection", root: ze(e.selection.getNode()) }),
    AF = (e, t, o) => {
      switch (o) {
        case "node":
          return (e => ({
      ...
      ET(a, hx.CLOSE_ON_EXECUTE, n, {
        ...
        t.preventDefault(),
          xf.showMenuAt(
            s,
            { anchor: i },
            { menu: { markers: Mx("normal") }, data: e }
          );
      });
    },
    DF = {
      onLtr: () => [Zl, Yl, Xl, Kl, Jl, Ql, fA, bA, hA, gA, pA, mA],
      onRtl: () => [Zl, Xl, Yl, Jl, Kl, Ql, fA, bA, pA, mA, hA, gA]
    },
    BF = {
      valignCentre: [],
      alignCentre: [],
        ...
        u = () => {
          ...
          ((e, t, o, n, s, r, a) => {
            const i = ((e, t, o) => {
              const n = AF(e, t, o);
              return {
                bubble: Wc(0, "point" === o ? 12 : 0, BF),
                layouts: DF,
                overrides: { maxWidthFunction: bD(), maxHeightFunction: Lc() },
                ...n
              };
            })(e, t, r);
            ET(o, hx.CLOSE_ON_EXECUTE, n, {
              isHorizontalMenu: !0,
              search: A.none()
            }).map(o => {
              t.preventDefault();
              ...
              xf.showMenuWithinBounds(
                ...
                { anchor: i },
                {
                  menu: { markers: Mx("normal"), highlightOnOpen: l },
                  data: o,
                  type: "horizontal"
                },
                () =>
                  A.some(tF(e, n.shared, "node" === r ? "node" : "selection"))
              ),
                e.dispatch(VI);
            });
          })(e, t, a, n, s, r, !(c || i || (l && d)));
    ...
    LF = (e, t) => (VF(e, t) ? e.selection.getStart(!0) : t.target),
    HF = (e, t, o) => {
      const n = Mo().deviceType.isTouch,
        ...
        i = t => {
          if (
            (SF(e) && t.preventDefault(),
            ((e, t) => t.ctrlKey && !SF(e))(e, t) ||
              (e => 0 === kF(e).length)(e))
          )
            return;
          const a = ((e, t) => {
            const o = CF(e),
              n = VF(e, t) ? "selection" : "point";
            if (Me(o)) {
              const s = LF(e, t);
              return $C(ze(s), o) ? "node" : n;
            }
            return n;
          })(e, t);
          (n() ? IF : MF)(
            ...
            () => {
              ...
              return ((e, t, o) => {
                const n = W(
                  ...
                  (t, n) =>
                    fe(e, n.toLowerCase())
                      .map(e => {
                        const n = e.update(o);
                        if (r(n) && Me(Ae(n))) return zF(t, n.split(" "));
                        if (l(n) && n.length > 0) {
                          const e = V(n, NF);
                          return zF(t, e);
                        }
                ...
                return n.length > 0 && FF(n[n.length - 1]) && n.pop(), n;
              })(n.contextMenus, s, o);
            },
            o,
            s,
    ...
    WF = e => t => t.translate(e.left, e.top),
    $F = e => (t, o) => W(e, (e, t) => t(e), jt(t, o)),
    jF = (e, t, o) => e.fold($F([WF(o), UF(t)]), $F([UF(t)]), $F([])),
    GF = (e, t, o) => e.fold($F([WF(o)]), $F([]), $F([WF(t)])),
    qF = (e, t, o) => e.fold($F([]), $F([UF(o)]), $F([WF(t), UF(o)])),
    YF = (e, t, o) => {
      const n = e.fold(
        (e, t) => ({
    ...
    XF = (e, t, o, n) => {
      ...
      return e.fold(s(qF, KF), s(GF, JF), s(jF, QF));
    },
    KF = PF.offset,
    JF = PF.absolute,
    QF = PF.fixed,
    ...
    eR = (e, t, o, n, s, r) => {
      const a = ((e, t, o, n) =>
          ((e, t) => {
            ...
            () => o,
            e => QF(e.left + n.left, e.top + n.top)
          ))(e, t, o, n),
        i = t.mustSnap ? oR(e, t, a, s, r) : nR(e, t, a, s, r),
        l = jF(a, s, r);
      return (
        ((e, t, o) => {
          const n = e.element;
        ...
        i.fold(
          () => ({ coord: QF(l.left, l.top), extra: A.none() }),
  ...
  const dR = [
    ...
    uR = e => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(
            ((e, t, o) =>
              ("fixed" === o ? QF : KF)(parseInt(e, 10), parseInt(t, 10)))(
              t.getOrDie(),
              o.getOrDie(),
              n.getOrDie()
            )
    ...
    gR = (e, t, o, n, s) => {
      const r = o.update(n, s),
        a = o.getStartData().getOrThunk(() => mR(t, e));
      r.each(o => {
        ((e, t, o, n) => {
          const s = t.getTarget(e.element);
          if (t.repositionTarget) {
                ...
                ((e, t, o, n, s) => {
                  ...
                  t.fold(
                    () => {
                      ...
                      var t, a, i;
                      const l = jF(e, n, s);
                      return QF(l.left, l.top);
                    },
                    t => {
                      const a = eR(e, t, o, r, n, s);
                      return (
                        a.extra.each(o => {
                          t.onSensor(e, o);
                        }),
  ...
  const bR = (e, t, o) => [
    ...
    vR = [...dR, wi("dragger", { handlers: hR(bR) })];
  ...
  const yR = (e, t, o) => {
    ...
    wR = vR,
    SR = [...dR, wi("dragger", { handlers: hR(yR) })],
    CR = [
      ...dR,
      wi("dragger", {
        handlers: hR((e, t, o) => [...bR(e, t, o), ...yR(e, t, o)])
      })
    ];
  ...
  const _R = ga({
      ...
      e.fold(
        ...
        e => {
          ...
          return _R.snap({
            sensor: JF(s, r),
            range: jt(40, 40),
            output: JF(A.some(o - a.width / 2), A.some(n - a.height / 2)),
            extra: { td: t }
          });
        }
      ),
    ...
    MR = (e, t) => {
      const o = en([]),
        ...
        i = e => {
          const o = Jo(e);
          return TR(u.getOpt(t), e, o.x, o.y, o.width, o.height);
        },
        l = e => {
          const o = Jo(e);
          return TR(m.getOpt(t), e, o.right, o.bottom, o.width, o.height);
        },
        c = ER(
          () => V(o.get(), e => i(e)),
          r,
    ...
    DR = (e, t, o) => {
      ...
      return {
        ...
        behaviours: ca([
          ...
          Ew(() => o.checkUiComponentContext("any")),
          Ub.config({}),
          _h.config({}),
  ...
  const IR = (e, t, o) => {
      const n = ze(e.getContainer()),
        s = ((e, t, o, n, s) => {
          const r = { height: DI(n + t.top, Ff(e), Nf(e)) };
          return o === BR.Both && (r.width = DI(s + t.left, If(e), Rf(e))), r;
        })(e, t, o, Ut(n), Kt(n));
      ie(s, (e, t) => {
        h(e) && Mt(n, t, MI(e));
      }),
            ...
            o.push(
              (() => {
                ...
                return {
                  ...
                  components: [dl(tx.translate(["Press {0} for help", e]))]
                };
              })()
            ),
          r &&
                    ...
                    o.push(
                      ((e, t) => {
                        ...
                        return zb.sketch({
                          ...
                          buttonBehaviours: ca([
                            fw(t.isDisabled),
                            Ew(() => t.checkUiComponentContext("any")),
                            Ub.config({}),
                            _h.config({}),
                            $u.config({
                              store: {
    ...
    NR = (e, t) => t.get().getOrDie(`UI for ${e} has not been rendered`),
    zR = (e, t) => {
      const o = e.inline,
        n = o ? zI : EI,
        s = Tb(e) ? VM : EM,
        ...
        b = r.lazyGetInOuterOrDie("toolbar", pB.getToolbar),
        v = r.lazyGetInOuterOrDie("throbber", pB.getThrobber),
        x = ((e, t, o, n) => {
          const s = en(!1),
            r = (e => {
            ...
            d = (e => ({ isDraggableModal: RA(e) }))(t),
            u = {
              shared: {
                providers: a,
                anchors: MA(t, o, n, r.isPositionedAtTop),
                header: r
              },
              urlinput: i,
              styles: l,
        ...
        y = () => {
          const t = (() => {
              const t = {
                ...
                i = fb(e),
                l = ub(e),
                c = pB.parts.promotion({
                  dom: { tag: "div", classes: ["tox-promotion"] }
                }),
                g = r || a || i,
                h = l ? [c, o] : [o];
              return pB.parts.header({
                dom: {
                  tag: "div",
            ...
            r = pB.parts.viewWrapper({ backstage: x.popup }),
            i =
              rb(e) && !o ? A.some(RR(e, x.popup.shared.providers)) : A.none(),
            l = G([d ? [] : [t], o ? [] : [n], d ? [t] : []]),
            h = pB.parts.editorContainer({
      ...
      return {
        popups: { backstage: x.popup, getMothership: () => NR("popups", l) },
        dialogs: { backstage: x.dialog, getMothership: () => NR("dialogs", i) },
        renderUI: () => {
          const o = y(),
            a = (() => {
              const t = Ob(e),
                ...
                n = {
                  dom: {
                    ...
                    attributes: { ...(tx.isRtl() ? { dir: "rtl" } : {}) }
                  },
                  behaviours: ca([Qd.config({ useFixed: () => s.isDocked(p) })])
                },
                r = {
            ...
            (f = o.outerContainer),
              ...
              e.addCommand("ToggleToolbarDrawer", (e, t) => {
                (null == t ? void 0 : t.skipFocus)
                  ? pB.toggleToolbarDrawerWithoutFocusing(f)
                  : pB.toggleToolbarDrawer(f);
              }),
              e.addQueryStateHandler("ToggleToolbarDrawer", () =>
                pB.isToolbarDrawerToggled(f)
              ),
              ((e, t, o) => {
                const n = (e, n) => {
                    L([t, ...o], t => {
              ...
              xF(e, x.popup),
              HF(e, x.popup.shared.getSink, x.popup),
              (e => {
              ...
              lD(e, v, x.popup.shared),
              dF(e, c, r.sink, { backstage: x.popup }),
              MR(e, r.sink);
            const b = {
    ...
    HR = y([
      ...
      vm({ factory: LR, schema: [rs("dom")], name: "close" }),
      vm({ factory: LR, schema: [rs("dom")], name: "body" }),
      ym({ factory: LR, schema: [rs("dom")], name: "footer" }),
      xm({
        factory: {
    ...
    jR = [...$R, ry],
    GR = [ls("type", ["submit", "cancel", "custom"]), ...jR],
    qR = [ls("type", ["menu"]), hy, vy, by, ms("items", UR), ...$R],
    YR = [...$R, ls("type", ["togglebutton"]), vy, by, hy, _s("active", !1)],
    XR = es("type", {
      submit: GR,
      cancel: GR,
      custom: GR,
    ...
    eN = [oy, ny],
    tN = eN.concat([xy]),
    oN = eN.concat([sy, ky, ks("context", "mode:design")]),
    nN = Fn(oN),
    sN = Wn,
    rN = tN.concat([_y("auto"), ks("context", "mode:design")]),
    aN = Fn(rN),
    iN = Vn([ly, ry, iy]),
    lN = tN.concat([ks("storageKey", "default"), ks("context", "mode:design")]),
    cN = Fn(lN),
    dN = Un,
    uN = Fn(tN),
    mN = Un,
    ...
    pN = eN.concat([ks("tag", "textarea"), cs("init")]),
    hN = Yn(e =>
      Kn("customeditor.old", In(pN), e).orThunk(() =>
        Kn("customeditor.new", In(gN), e)
      )
    ),
    fN = Un,
    bN = tN.concat([ks("context", "mode:design")]),
    vN = Fn(bN),
    xN = Rn(En),
    yN = e => [oy, as("columns", Pn), e],
    wN = [
      oy,
      is("html"),
    ...
    kN = Fn(CN),
    ON = Un,
    _N = Fn(eN.concat([fs("height")])),
    TN = Fn([is("url"), hs("zoom"), hs("cachedWidth"), hs("cachedHeight")]),
    EN = tN.concat([
      fs("inputMode"),
      fs("placeholder"),
      _s("maximized", !1),
    ...
    FN = Nn([Fn(BN), Fn(IN)]),
    RN = tN.concat([ms("items", FN), ky, ks("context", "mode:design")]),
    NN = Fn(RN),
    zN = Un,
    VN = tN.concat([
      us("items", [ry, ly]),
    ...
    LN = Fn(VN),
    HN = Un,
    PN = tN.concat([_s("constrain", !0), ky, ks("context", "mode:design")]),
    UN = Fn(PN),
    WN = Fn([is("width"), is("height")]),
    $N = eN.concat([sy, Cs("min", 0), Cs("max", 0)]),
    jN = Fn($N),
    GN = Pn,
    qN = [oy, ms("header", Un), ms("cells", Rn(Un))],
    YN = Fn(qN),
    XN = tN.concat([
      fs("placeholder"),
      _s("maximized", !1),
    ...
    ez = QN.concat([
      ms(
        "children",
        ts(0, () => qn("type", { directory: tz, leaf: ZN }))
      )
    ]),
    tz = Fn(ez),
    oz = qn("type", { directory: tz, leaf: ZN }),
    nz = [
      oy,
      ms("items", oz),
      vs("onLeafAction"),
    ...
    lz = e =>
      os(
        ...
        Rn(
          Yn(t =>
            Kn(`Checking item of ${e}`, cz, t).fold(
              e => ln.error(Zn(e)),
              e => ln.value(e)
            )
          )
    ...
    dz = [oy, ws("classes", []), ms("items", cz)],
    uz = Fn(dz),
    mz = [My("tab"), ay, ms("items", cz)],
    gz = [oy, us("tabs", mz)],
    pz = Fn(gz),
    hz = jR,
    fz = XR,
    bz = Fn([
      is("title"),
      as("body", qn("type", { panel: uz, tabpanel: pz })),
      ks("size", "normal"),
      Es("buttons", [], fz),
      ws("initialData", {}),
      Ts("onAction", b),
    ...
    vz = Fn([ls("type", ["cancel", "custom"]), ...hz]),
    xz = Fn([
      is("title"),
      is("url"),
      hs("height"),
    ...
    yz = e => (a(e) ? [e].concat(q(he(e), yz)) : l(e) ? q(e, yz) : []),
    wz = e => r(e.type) && r(e.name),
    Sz = {
      checkbox: sN,
      colorinput: dN,
      colorpicker: mN,
    ...
    Cz = e => {
      const t = (e => P(yz(e), wz))(e),
        o = q(t, e =>
          (e => A.from(Sz[e.type]))(e).fold(
            () => [],
            t => [as(e.name, t)]
          )
        );
    ...
    kz = e => {
      var t;
      return {
        internalDialog: Jn(Kn("dialog", bz, e)),
        dataValidator: Cz(e),
    ...
    Oz = {
      ...
      openUrl: (e, t) => e(Jn(Kn("dialog", xz, t))),
      redial: e => kz(e)
    };
  var _z = Object.freeze({
      __proto__: null,
      events: (e, t) => {
        const o = (o, n) => {
    ...
    Tz = Object.freeze({ __proto__: null, getState: (e, t, o) => o }),
    Ez = [
      rs("channel"),
      gs("renderComponents"),
      gs("updateState"),
  ...
  const Az = ua({
    ...
    Dz = (e, t, o, n) => {
      const s = Lb(
        k_.sketch(s => ({
          ...
          components: V(e.items, e => oA(s, e, t, o, n))
        }))
      );
      return {
        ...
        behaviours: ca([
          bh.config({ mode: "acyclic", useTabstopAt: k(Q_) }),
          ((r = s), Jm.config({ find: r.getOpt })),
          R_(s, {
            postprocess: e => Mz(e).fold(e => (console.error(e), {}), w)
          }),
          Th("dialog-body-panel", [
            Wr(Xs(), (e, t) => {
              e.getSystem().broadcastOn([sT], {
    ...
    jz = e => Ol(e, '[role="tabpanel"]'),
    Gz = "send-data-to-section",
    qz = "send-data-to-view",
    Yz = (e, t, o, n) => {
      const s = en({}),
        r = e => {
          const t = $u.getValue(e),
          ...
          view: () => [
            k_.sketch(s => ({
              ...
              formBehaviours: ca([
                ...
                dc.config({
                  channels: Bs([
                    { key: Gz, value: { onReceive: r } },
                    { key: qz, value: { onReceive: a } }
                  ])
                })
              ])
            }))
      ...
      return Uz.sketch({
        ...
        onChangeTab: (e, t, o) => {
          const n = $u.getValue(t);
          Rr(e, vk, { name: n, oldName: i.get() }), i.set(n);
        },
        tabs: l,
        components: [
          Uz.parts.tabbar({
            dom: { tag: "div", classes: ["tox-dialog__body-nav"] },
            components: [Nz.parts.tabs({})],
            markers: {
              tabClass: "tox-tab",
        ...
        tabSectionBehaviours: ca([
          ...
          bh.config({ mode: "acyclic" }),
          Jm.config({ find: e => te(Uz.getViewItems(e)) }),
          N_(
            A.none(),
            e => (e.getSystem().broadcastOn([Gz], {}), s.get()),
            (e, t) => {
              s.set(t), e.getSystem().broadcastOn([qz], {});
            }
          )
        ])
      });
        ...
        Az.config({
          ...
          renderComponents: e => {
            ...
            return "tabpanel" === t.type
              ? [Yz(t, e.initialData, n, r)]
              : [Dz(t, e.initialData, n, r)];
          },
          initialData: e
        })
      ])
    }),
    Kz = Of.deviceType.isTouch(),
    Jz = (e, t) => ({
      dom: {
        tag: "div",
        styles: { display: "none" },
    ...
    eV = (e, t) =>
      PR.parts.body({
        ...
        components: [
          {
            dom: { tag: "div", classes: ["tox-dialog__body-content"] },
            components: [{ dom: Vb(`<p>${ex(t.translate(e))}</p>`) }]
          }
        ]
      }),
    tV = e =>
      ...
      return PR.sketch({
        ...
        parts: {
          blocker: {
            ...
            components: [
              { dom: { tag: "div", classes: Kz ? [n, n + "--opaque"] : [n] } }
            ]
          }
        },
        dragBlockClass: o,
        modalBehaviours: ca([
          ...
          Th(
            ...
            e.dialogEvents.concat([
              Kr(Xs(), (e, t) => {
                aD.isBlocked(e) || bh.focusIn(e);
              }),
              Wr(Tr(), (e, t) => {
                e.getSystem().broadcastOn([sT], { newFocus: t.event.newFocus });
              })
            ])
          ),
          Th("scroll-lock", [
    ...
    sV = e =>
      zb.sketch({
        ...
        buttonBehaviours: ca([
          Ub.config({}),
          Zb.config(e.tooltips.getConfig({ tooltipText: e.translate("Close") }))
        ]),
        components: [
          dx("close", { tag: "span", classes: ["tox-icon"] }, e.icons)
        ],
        action: e => {
          Fr(e, gk);
        }
    ...
    aV = () => ({ dom: Vb('<div class="tox-dialog__draghandle"></div>') }),
    iV = (e, t, o) =>
      ((e, t, o) => {
        const n = PR.parts.title(rV(e, t, A.none(), o)),
          s = PR.parts.draghandle(aV()),
          r = PR.parts.close(sV(o)),
    ...
    cV = (e, t, o) => ({
      ...
      onBlock: o => {
        ...
        PR.setBusy(e(), (e, s) => lV(o.message, s, t, n));
      },
      onUnblock: () => {
        PR.setIdle(e());
      }
    }),
    dV = "tox-dialog--fullscreen",
    uV = "tox-dialog--width-lg",
    mV = "tox-dialog--width-md",
    gV = e => {
      switch (e) {
        case "large":
          return A.some(uV);
    ...
    pV = (e, t) => {
      ...
      Ca(o, dV) || (Oa(o, [uV, mV]), gV(e).each(e => ya(o, e)));
    },
    hV = (e, t) => {
      const o = ze(e.element.dom),
        n = _a(o),
        s = $(n, e => e === uV || e === mV).or(gV(t));
      ((e, t) => {
        L(t, t => {
          ((e, t) => {
            const o = fa(e)
              ? e.dom.classList.toggle(t)
              : ((e, t) => (F(ba(e), t) ? xa(e, t) : va(e, t)))(e, t);
            wa(e);
          })(e, t);
        });
      })(o, [dV, ...s.toArray()]);
    ...
    fV = (e, t, o) =>
      pl(
        nV({
          ...
          extraBehaviours: [V_({}), ...e.extraBehaviours],
          onEscape: e => {
            Fr(e, gk);
          },
          dialogEvents: t,
    ...
    xV = (e, t) => [
      ...
      e(gk, (e, t, o, n) => {
        t.onCancel(e), Fr(n, mk);
      }),
      Wr(bk, (e, o) => t.onUnblock()),
      Wr(fk, (e, o) => t.onBlock(o.event))
    ],
    yV = (e, t, o) => {
      const n = (t, o) =>
          Wr(t, (t, n) => {
        ...
        Az.config({
          ...
          updateState: (e, t) => {
            const n = V(t.buttons, e => {
              const t = Lb(((e, t) => HE(e, e.type, t))(e, o));
    ...
    CV = (e, t, o) => PR.parts.footer(SV(e, t, o)),
    kV = (e, t) => {
      if (e.getRoot().getSystem().isConnected()) {
        const o = Jm.getCurrent(e.getFormWrapper()).getOr(e.getFormWrapper());
        return k_.getField(o, t).orThunk(() => {
          const o = e.getFooter().bind(e => Az.getState(e).get());
    ...
    OV = (e, t, o) => {
      const n = t => {
        ...
        s = {
          ...
          setEnabled: (t, o) => {
            kV(e, t).each(o ? ug.enable : ug.disable);
          },
          focus: t => {
            kV(e, t).each(Bh.focus);
          },
          block: e => {
            if (!r(e))
              throw new Error(
          ...
          redial: r => {
            n(n => {
              const a = e.getId(),
                i = t(r),
                l = bV(i.internalDialog.buttons, o);
              n.getSystem().broadcastOn([`${Z_}-${a}`], i),
                n.getSystem().broadcastOn([`${eT}-${a}`], i.internalDialog),
                n.getSystem().broadcastOn([`${tT}-${a}`], i.internalDialog),
                n.getSystem().broadcastOn([`${oT}-${a}`], {
                  ...i.internalDialog,
                  buttons: l
                }),
      ...
      const r = Di("dialog"),
        ...
        u = Lb(
          ((e, t, o, n) =>
            ek.sketch({
              dom: Vb('<div class="tox-dialog__header"></div>'),
              components: [rV(e, t, A.some(o), n), aV(), sV(n)],
              containerBehaviours: ca([
                _R.config({
                  mode: "mouse",
                  blockerClass: "blocker",
        ...
        m = Lb(
          ((e, t, o, n, s, r) => Xz(e, t, A.some(o), n, s, r))(
        ...
        h = Ce(
          0 !== g.length,
          Lb(((e, t, o) => SV(e, t, o))({ buttons: g }, r, o))
        ),
        f = yV(
          () => w,
          {
            onBlock: e => {
              aD.block(v, (t, n) => {
                ...
                return lV(e.message, n, o.shared.providers, s);
              });
            },
            onUnblock: () => {
              aD.unblock(v);
  ...
  const EV = [
    ...
    AV = e => a(e) && -1 !== EV.indexOf(e.mceAction),
    MV = (e, t, o, n) => {
      const s = Di("dialog"),
        i = iV(e.title, s, n),
        l = (e => {
          ...
          return PR.parts.body(t);
        })(e),
        c = e.buttons.bind(e =>
          0 === e.length ? A.none() : A.some(CV({ buttons: e }, s, n))
        ),
        u = ((e, t) => {
          const o = (e, t) =>
              Wr(e, (e, o) => {
    ...
    DV = (e, t) => Jn(Kn("data", t, e)),
    BV = e => $C(e, ".tox-alert-dialog") || $C(e, ".tox-confirm-dialog"),
    IV = (e, t, o) =>
      t && o
        ? []
        : [
              ...
              const s = () => {
                ...
                l = pl(
                  nV({
                    lazySink: () => t.getSink(),
                    header: Jz(a, i),
                    body: eV(o, t.providers),
                    footer: A.some(tV(oV([], [r.asSpec()]))),
                    onEscape: s,
                    extraClasses: ["tox-alert-dialog"],
                    extraBehaviours: [],
                    extraStyles: {},
                    dialogEvents: [Wr(gk, s)],
                    eventOrder: {}
                  })
                );
              PR.show(l);
          ...
          return {
            open: (o, n) => {
              const s = e => {
                ...
                i = Zz(),
                l = Qz(() => s(!1), t.providers),
                c = pl(
                  nV({
                    lazySink: () => t.getSink(),
                    header: Jz(i, l),
                    body: eV(o, t.providers),
                    footer: A.some(tV(oV([], [a, r.asSpec()]))),
                    onEscape: () => s(!1),
                    extraClasses: ["tox-confirm-dialog"],
                    extraBehaviours: [],
                    extraStyles: {},
                    dialogEvents: [Wr(gk, () => s(!1)), Wr(hk, () => s(!0))],
                    eventOrder: {}
                  })
                );
              PR.show(c);
            ...
            const r = n,
              a = ((e, t, o) => {
                const n = Di("dialog"),
                  ...
                  i = gV(a.get()).toArray(),
                  l = ((e, t, o, n) => {
                    const s = Xz(e, t, A.none(), o, !1, n);
                    return PR.parts.body(s);
                  })({ body: s.body, initialData: s.initialData }, n, o, e =>
                    kV(h, e)
                  ),
                  c = bV(s.buttons),
                  d = vV(c),
                  u = Ce(0 !== c.length, CV({ buttons: c }, n, o)),
                  m = yV(
                    () => f,
                    cV(() => p, o.shared.providers, t),
                    o.shared.getSink
                  ),
                  g = {
                    id: n,
                  ...
                  h = {
                    getId: y(n),
                    getRoot: y(p),
                    getBody: () => PR.getBody(p),
                    getFooter: () => PR.getFooter(p),
                    getFormWrapper: () => {
                      const e = PR.getBody(p);
                      return Jm.getCurrent(e).getOr(e);
                    },
                    toggleFullscreen: () => {
                      hV(p, a.get());
                ...
                { dataValidator: s, initialData: r, internalDialog: t },
                {
                  redial: Oz.redial,
                  closeWindow: () => {
                    PR.hide(a.dialog), o(a.instanceApi);
                  }
                },
                e.backstages.dialog
              );
            return PR.show(a.dialog), a.instanceApi.setData(r), a.instanceApi;
          }, t),
        a = (n, s, r, a) =>
          Oz.open((n, i, l) => {
            const c = DV(i, l),
          ...
          ((o, n) =>
            Oz.openUrl(o => {
              const s = MV(
                ...
                {
                  closeWindow: () => {
                    PR.hide(s.dialog), n(s.instanceApi);
                  }
                },
                t,
                e.backstages.dialog
              );
              return PR.show(s.dialog), s.instanceApi;
            }, o))(o, n),
        alert: (e, t) => {
          n.open(e, t);
        },
      ...
      Ef(e),
        (e => {
          ...
          t("color_map", {
            ...
            t("color_cols", { processor: n, default: NS(e) }),
            t("color_cols_foreground", { processor: n, default: zS(e, MS) }),
            t("color_cols_background", { processor: n, default: zS(e, DS) }),
            t("custom_colors", { processor: "boolean", default: !0 }),
            t("color_default_foreground", { processor: "string", default: FS }),
            t("color_default_background", { processor: "string", default: FS });
        })(e),
        (e => {
          const t = e.options.register;
  ...
  sn.add("silver", e => {
    ...
    const {
      ...
      popups: n,
      renderUI: s
    } = zR(e, { getPopupSinkBounds: () => t() });
    WC(e, n.backstage.shared);
    const r = FV({
        editor: e,
    ...
    return {
      ...
      getNotificationManagerImpl: () =>
        gx(e, { backstage: n.backstage }, n.getMothership(), a)
    };
  });
})();
